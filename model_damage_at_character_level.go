...
// GetDamageAtCharacterLevel returns the DamageAtCharacterLevel field value if set, zero value otherwise.
func (o *DamageAtCharacterLevel) GetDamageAtCharacterLevel() map[string]interface{} {
	if o == nil || isNil(o.DamageAtCharacterLevel) {
		var ret map[string]interface{}
		return ret
	}
	return o.DamageAtCharacterLevel
}

// GetDamageAtCharacterLevelOk returns a tuple with the DamageAtCharacterLevel field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DamageAtCharacterLevel) GetDamageAtCharacterLevelOk() (map[string]interface{}, bool) {
	if o == nil || isNil(o.DamageAtCharacterLevel) {
    return map[string]interface{}{}, false
	}
	return o.DamageAtCharacterLevel, true
}
...
// SetDamageAtCharacterLevel gets a reference to the given map[string]interface{} and assigns it to the DamageAtCharacterLevel field.
func (o *DamageAtCharacterLevel) SetDamageAtCharacterLevel(v map[string]interface{}) {
	o.DamageAtCharacterLevel = v
}

// GetDamageType returns the DamageType field value if set, zero value otherwise.
func (o *DamageAtCharacterLevel) GetDamageType() APIReference {
	if o == nil || isNil(o.DamageType) {
...
// GetDamageTypeOk returns a tuple with the DamageType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DamageAtCharacterLevel) GetDamageTypeOk() (*APIReference, bool) {
	if o == nil || isNil(o.DamageType) {
    return nil, false
	}
	return o.DamageType, true
}
...
// SetDamageType gets a reference to the given APIReference and assigns it to the DamageType field.
func (o *DamageAtCharacterLevel) SetDamageType(v APIReference) {
	o.DamageType = &v
}

func (o DamageAtCharacterLevel) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.DamageAtCharacterLevel) {
		toSerialize["damage_at_character_level"] = o.DamageAtCharacterLevel
	}
	if !isNil(o.DamageType) {
		toSerialize["damage_type"] = o.DamageType
	}
	return json.Marshal(toSerialize)
}

type NullableDamageAtCharacterLevel struct {
	value *DamageAtCharacterLevel
	isSet bool
}

func (v NullableDamageAtCharacterLevel) Get() *DamageAtCharacterLevel {
	return v.value
}

func (v *NullableDamageAtCharacterLevel) Set(val *DamageAtCharacterLevel) {
	v.value = val
	v.isSet = true
}

func (v NullableDamageAtCharacterLevel) IsSet() bool {
	return v.isSet
}

func (v *NullableDamageAtCharacterLevel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDamageAtCharacterLevel(val *DamageAtCharacterLevel) *NullableDamageAtCharacterLevel {
	return &NullableDamageAtCharacterLevel{value: val, isSet: true}
}

func (v NullableDamageAtCharacterLevel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDamageAtCharacterLevel) UnmarshalJSON(src []byte) error {
	v.isSet = true
