...
// ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner struct for ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner
type ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner struct {
...
func NewClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner() *ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner {
	this := ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner{}
	return &this
}
...
// GetSpellSlotLevel returns the SpellSlotLevel field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner) GetSpellSlotLevel() float32 {
	if o == nil || isNil(o.SpellSlotLevel) {
		var ret float32
		return ret
	}
	return *o.SpellSlotLevel
}

// GetSpellSlotLevelOk returns a tuple with the SpellSlotLevel field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner) GetSpellSlotLevelOk() (*float32, bool) {
	if o == nil || isNil(o.SpellSlotLevel) {
    return nil, false
	}
	return o.SpellSlotLevel, true
}
...
// SetSpellSlotLevel gets a reference to the given float32 and assigns it to the SpellSlotLevel field.
func (o *ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner) SetSpellSlotLevel(v float32) {
	o.SpellSlotLevel = &v
}

// GetSorceryPointCost returns the SorceryPointCost field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner) GetSorceryPointCost() float32 {
	if o == nil || isNil(o.SorceryPointCost) {
		var ret float32
		return ret
	}
	return *o.SorceryPointCost
}

// GetSorceryPointCostOk returns a tuple with the SorceryPointCost field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner) GetSorceryPointCostOk() (*float32, bool) {
	if o == nil || isNil(o.SorceryPointCost) {
    return nil, false
	}
	return o.SorceryPointCost, true
}
...
// SetSorceryPointCost gets a reference to the given float32 and assigns it to the SorceryPointCost field.
func (o *ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner) SetSorceryPointCost(v float32) {
	o.SorceryPointCost = &v
}

func (o ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.SpellSlotLevel) {
		toSerialize["spell_slot_level"] = o.SpellSlotLevel
	}
	if !isNil(o.SorceryPointCost) {
		toSerialize["sorcery_point_cost"] = o.SorceryPointCost
	}
	return json.Marshal(toSerialize)
}

type NullableClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner struct {
	value *ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner
	isSet bool
}

func (v NullableClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner) Get() *ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner {
	return v.value
}

func (v *NullableClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner) Set(val *ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner(val *ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner) *NullableClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner {
	return &NullableClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner{value: val, isSet: true}
}

func (v NullableClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
