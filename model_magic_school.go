...
func (o MagicSchool) MarshalJSON() ([]byte, error) {
...
type NullableMagicSchool struct {
	value *MagicSchool
	isSet bool
}

func (v NullableMagicSchool) Get() *MagicSchool {
	return v.value
}

func (v *NullableMagicSchool) Set(val *MagicSchool) {
	v.value = val
	v.isSet = true
}

func (v NullableMagicSchool) IsSet() bool {
	return v.isSet
}

func (v *NullableMagicSchool) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMagicSchool(val *MagicSchool) *NullableMagicSchool {
	return &NullableMagicSchool{value: val, isSet: true}
}

func (v NullableMagicSchool) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMagicSchool) UnmarshalJSON(src []byte) error {
	v.isSet = true
