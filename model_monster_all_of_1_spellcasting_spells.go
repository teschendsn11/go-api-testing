...
// MonsterAllOf1SpellcastingSpells struct for MonsterAllOf1SpellcastingSpells
type MonsterAllOf1SpellcastingSpells struct {
...
func NewMonsterAllOf1SpellcastingSpells() *MonsterAllOf1SpellcastingSpells {
	this := MonsterAllOf1SpellcastingSpells{}
	return &this
}
...
func (o MonsterAllOf1SpellcastingSpells) MarshalJSON() ([]byte, error) {
...
type NullableMonsterAllOf1SpellcastingSpells struct {
	value *MonsterAllOf1SpellcastingSpells
	isSet bool
}

func (v NullableMonsterAllOf1SpellcastingSpells) Get() *MonsterAllOf1SpellcastingSpells {
	return v.value
}

func (v *NullableMonsterAllOf1SpellcastingSpells) Set(val *MonsterAllOf1SpellcastingSpells) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterAllOf1SpellcastingSpells) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterAllOf1SpellcastingSpells) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterAllOf1SpellcastingSpells(val *MonsterAllOf1SpellcastingSpells) *NullableMonsterAllOf1SpellcastingSpells {
	return &NullableMonsterAllOf1SpellcastingSpells{value: val, isSet: true}
}

func (v NullableMonsterAllOf1SpellcastingSpells) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterAllOf1SpellcastingSpells) UnmarshalJSON(src []byte) error {
	v.isSet = true
