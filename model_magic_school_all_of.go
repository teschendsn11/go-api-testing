...
// MagicSchoolAllOf struct for MagicSchoolAllOf
type MagicSchoolAllOf struct {
...
func (o MagicSchoolAllOf) MarshalJSON() ([]byte, error) {
...
type NullableMagicSchoolAllOf struct {
	value *MagicSchoolAllOf
	isSet bool
}

func (v NullableMagicSchoolAllOf) Get() *MagicSchoolAllOf {
	return v.value
}

func (v *NullableMagicSchoolAllOf) Set(val *MagicSchoolAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableMagicSchoolAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableMagicSchoolAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMagicSchoolAllOf(val *MagicSchoolAllOf) *NullableMagicSchoolAllOf {
	return &NullableMagicSchoolAllOf{value: val, isSet: true}
}

func (v NullableMagicSchoolAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMagicSchoolAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
