...
type ApiApiClassesIndexGetRequest struct {
	ctx context.Context
	ApiService *ClassApiService
	index string
}

func (r ApiApiClassesIndexGetRequest) Execute() (*Class, *http.Response, error) {
	return r.ApiService.ApiClassesIndexGetExecute(r)
}

/*
ApiClassesIndexGet Get a class by index.
...
A character's class affects a character's available skills and abilities. [[SRD p8-55](https://media.wizards.com/2016/downloads/DND/SRD-OGL_V5.1.pdf#page=8)]
 ...
 @return ApiApiClassesIndexGetRequest
*/
func (a *ClassApiService) ApiClassesIndexGet(ctx context.Context, index string) ApiApiClassesIndexGetRequest {
	return ApiApiClassesIndexGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
//  @return Class
func (a *ClassApiService) ApiClassesIndexGetExecute(r ApiApiClassesIndexGetRequest) (*Class, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClassApiService.ApiClassesIndexGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/classes/{index}"
...
type ApiApiClassesIndexMultiClassingGetRequest struct {
	ctx context.Context
	ApiService *ClassApiService
	index string
}

func (r ApiApiClassesIndexMultiClassingGetRequest) Execute() (*Multiclassing, *http.Response, error) {
	return r.ApiService.ApiClassesIndexMultiClassingGetExecute(r)
}

/*
ApiClassesIndexMultiClassingGet Get multiclassing resource for a class.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the class to get. 
 @return ApiApiClassesIndexMultiClassingGetRequest
*/
func (a *ClassApiService) ApiClassesIndexMultiClassingGet(ctx context.Context, index string) ApiApiClassesIndexMultiClassingGetRequest {
	return ApiApiClassesIndexMultiClassingGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
func (a *ClassApiService) ApiClassesIndexMultiClassingGetExecute(r ApiApiClassesIndexMultiClassingGetRequest) (*Multiclassing, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *Multiclassing
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClassApiService.ApiClassesIndexMultiClassingGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/classes/{index}/multi-classing"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
...
type ApiApiClassesIndexSpellcastingGetRequest struct {
	ctx context.Context
	ApiService *ClassApiService
	index string
}

func (r ApiApiClassesIndexSpellcastingGetRequest) Execute() (*Spellcasting, *http.Response, error) {
	return r.ApiService.ApiClassesIndexSpellcastingGetExecute(r)
}

/*
ApiClassesIndexSpellcastingGet Get spellcasting info for a class.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the class to get. 
 @return ApiApiClassesIndexSpellcastingGetRequest
*/
func (a *ClassApiService) ApiClassesIndexSpellcastingGet(ctx context.Context, index string) ApiApiClassesIndexSpellcastingGetRequest {
	return ApiApiClassesIndexSpellcastingGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
// Execute executes the request
//  @return Spellcasting
func (a *ClassApiService) ApiClassesIndexSpellcastingGetExecute(r ApiApiClassesIndexSpellcastingGetRequest) (*Spellcasting, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *Spellcasting
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClassApiService.ApiClassesIndexSpellcastingGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/classes/{index}/spellcasting"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
