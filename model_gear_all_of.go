...
// GearAllOf struct for GearAllOf
type GearAllOf struct {
...
func (o GearAllOf) MarshalJSON() ([]byte, error) {
...
type NullableGearAllOf struct {
	value *GearAllOf
	isSet bool
}

func (v NullableGearAllOf) Get() *GearAllOf {
	return v.value
}

func (v *NullableGearAllOf) Set(val *GearAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableGearAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableGearAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGearAllOf(val *GearAllOf) *NullableGearAllOf {
	return &NullableGearAllOf{value: val, isSet: true}
}

func (v NullableGearAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGearAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
