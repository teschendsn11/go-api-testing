...
// MonsterAllOf1Actions struct for MonsterAllOf1Actions
type MonsterAllOf1Actions struct {
...
func (o MonsterAllOf1Actions) MarshalJSON() ([]byte, error) {
...
type NullableMonsterAllOf1Actions struct {
	value *MonsterAllOf1Actions
	isSet bool
}

func (v NullableMonsterAllOf1Actions) Get() *MonsterAllOf1Actions {
	return v.value
}

func (v *NullableMonsterAllOf1Actions) Set(val *MonsterAllOf1Actions) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterAllOf1Actions) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterAllOf1Actions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterAllOf1Actions(val *MonsterAllOf1Actions) *NullableMonsterAllOf1Actions {
	return &NullableMonsterAllOf1Actions{value: val, isSet: true}
}

func (v NullableMonsterAllOf1Actions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterAllOf1Actions) UnmarshalJSON(src []byte) error {
	v.isSet = true
