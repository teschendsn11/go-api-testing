...
// MonsterAllOf1Speed Speed for a monster determines how fast it can move per turn.
type MonsterAllOf1Speed struct {
...
func (o MonsterAllOf1Speed) MarshalJSON() ([]byte, error) {
...
type NullableMonsterAllOf1Speed struct {
	value *MonsterAllOf1Speed
	isSet bool
}

func (v NullableMonsterAllOf1Speed) Get() *MonsterAllOf1Speed {
	return v.value
}

func (v *NullableMonsterAllOf1Speed) Set(val *MonsterAllOf1Speed) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterAllOf1Speed) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterAllOf1Speed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterAllOf1Speed(val *MonsterAllOf1Speed) *NullableMonsterAllOf1Speed {
	return &NullableMonsterAllOf1Speed{value: val, isSet: true}
}

func (v NullableMonsterAllOf1Speed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterAllOf1Speed) UnmarshalJSON(src []byte) error {
	v.isSet = true
