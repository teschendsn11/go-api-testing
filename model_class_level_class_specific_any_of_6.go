...
// ClassLevelClassSpecificAnyOf6 Paladin Class Specific Features
type ClassLevelClassSpecificAnyOf6 struct {
...
func NewClassLevelClassSpecificAnyOf6() *ClassLevelClassSpecificAnyOf6 {
	this := ClassLevelClassSpecificAnyOf6{}
	return &this
}
...
// GetAuraRange returns the AuraRange field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf6) GetAuraRange() float32 {
	if o == nil || isNil(o.AuraRange) {
		var ret float32
		return ret
	}
	return *o.AuraRange
...
// GetAuraRangeOk returns a tuple with the AuraRange field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf6) GetAuraRangeOk() (*float32, bool) {
	if o == nil || isNil(o.AuraRange) {
    return nil, false
	}
	return o.AuraRange, true
}
...
// SetAuraRange gets a reference to the given float32 and assigns it to the AuraRange field.
func (o *ClassLevelClassSpecificAnyOf6) SetAuraRange(v float32) {
	o.AuraRange = &v
}

func (o ClassLevelClassSpecificAnyOf6) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.AuraRange) {
		toSerialize["aura_range"] = o.AuraRange
	}
	return json.Marshal(toSerialize)
}

type NullableClassLevelClassSpecificAnyOf6 struct {
	value *ClassLevelClassSpecificAnyOf6
	isSet bool
}

func (v NullableClassLevelClassSpecificAnyOf6) Get() *ClassLevelClassSpecificAnyOf6 {
	return v.value
}

func (v *NullableClassLevelClassSpecificAnyOf6) Set(val *ClassLevelClassSpecificAnyOf6) {
	v.value = val
	v.isSet = true
}

func (v NullableClassLevelClassSpecificAnyOf6) IsSet() bool {
	return v.isSet
}

func (v *NullableClassLevelClassSpecificAnyOf6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClassLevelClassSpecificAnyOf6(val *ClassLevelClassSpecificAnyOf6) *NullableClassLevelClassSpecificAnyOf6 {
	return &NullableClassLevelClassSpecificAnyOf6{value: val, isSet: true}
}

func (v NullableClassLevelClassSpecificAnyOf6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClassLevelClassSpecificAnyOf6) UnmarshalJSON(src []byte) error {
	v.isSet = true
