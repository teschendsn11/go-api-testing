...
// ClassLevelClassSpecificAnyOf1 Bard Class Specific Features
type ClassLevelClassSpecificAnyOf1 struct {
...
func NewClassLevelClassSpecificAnyOf1() *ClassLevelClassSpecificAnyOf1 {
	this := ClassLevelClassSpecificAnyOf1{}
	return &this
}
...
// GetBardicInspirationDice returns the BardicInspirationDice field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf1) GetBardicInspirationDice() float32 {
	if o == nil || isNil(o.BardicInspirationDice) {
		var ret float32
		return ret
	}
	return *o.BardicInspirationDice
}

// GetBardicInspirationDiceOk returns a tuple with the BardicInspirationDice field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf1) GetBardicInspirationDiceOk() (*float32, bool) {
	if o == nil || isNil(o.BardicInspirationDice) {
    return nil, false
	}
	return o.BardicInspirationDice, true
}
...
// SetBardicInspirationDice gets a reference to the given float32 and assigns it to the BardicInspirationDice field.
func (o *ClassLevelClassSpecificAnyOf1) SetBardicInspirationDice(v float32) {
	o.BardicInspirationDice = &v
}

// GetSongOfRestDie returns the SongOfRestDie field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf1) GetSongOfRestDie() float32 {
	if o == nil || isNil(o.SongOfRestDie) {
		var ret float32
		return ret
	}
	return *o.SongOfRestDie
}

// GetSongOfRestDieOk returns a tuple with the SongOfRestDie field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf1) GetSongOfRestDieOk() (*float32, bool) {
	if o == nil || isNil(o.SongOfRestDie) {
    return nil, false
	}
	return o.SongOfRestDie, true
}
...
// SetSongOfRestDie gets a reference to the given float32 and assigns it to the SongOfRestDie field.
func (o *ClassLevelClassSpecificAnyOf1) SetSongOfRestDie(v float32) {
	o.SongOfRestDie = &v
}

// GetMagicalSecretsMax5 returns the MagicalSecretsMax5 field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf1) GetMagicalSecretsMax5() float32 {
	if o == nil || isNil(o.MagicalSecretsMax5) {
		var ret float32
		return ret
	}
	return *o.MagicalSecretsMax5
}

// GetMagicalSecretsMax5Ok returns a tuple with the MagicalSecretsMax5 field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf1) GetMagicalSecretsMax5Ok() (*float32, bool) {
	if o == nil || isNil(o.MagicalSecretsMax5) {
    return nil, false
	}
	return o.MagicalSecretsMax5, true
}
...
// SetMagicalSecretsMax5 gets a reference to the given float32 and assigns it to the MagicalSecretsMax5 field.
func (o *ClassLevelClassSpecificAnyOf1) SetMagicalSecretsMax5(v float32) {
	o.MagicalSecretsMax5 = &v
}

// GetMagicalSecretsMax7 returns the MagicalSecretsMax7 field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf1) GetMagicalSecretsMax7() float32 {
	if o == nil || isNil(o.MagicalSecretsMax7) {
		var ret float32
		return ret
	}
	return *o.MagicalSecretsMax7
}

// GetMagicalSecretsMax7Ok returns a tuple with the MagicalSecretsMax7 field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf1) GetMagicalSecretsMax7Ok() (*float32, bool) {
	if o == nil || isNil(o.MagicalSecretsMax7) {
    return nil, false
	}
	return o.MagicalSecretsMax7, true
}
...
// SetMagicalSecretsMax7 gets a reference to the given float32 and assigns it to the MagicalSecretsMax7 field.
func (o *ClassLevelClassSpecificAnyOf1) SetMagicalSecretsMax7(v float32) {
	o.MagicalSecretsMax7 = &v
}

// GetMagicalSecretsMax9 returns the MagicalSecretsMax9 field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf1) GetMagicalSecretsMax9() float32 {
	if o == nil || isNil(o.MagicalSecretsMax9) {
		var ret float32
		return ret
	}
	return *o.MagicalSecretsMax9
}

// GetMagicalSecretsMax9Ok returns a tuple with the MagicalSecretsMax9 field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf1) GetMagicalSecretsMax9Ok() (*float32, bool) {
	if o == nil || isNil(o.MagicalSecretsMax9) {
    return nil, false
	}
	return o.MagicalSecretsMax9, true
}
...
// SetMagicalSecretsMax9 gets a reference to the given float32 and assigns it to the MagicalSecretsMax9 field.
func (o *ClassLevelClassSpecificAnyOf1) SetMagicalSecretsMax9(v float32) {
	o.MagicalSecretsMax9 = &v
}

func (o ClassLevelClassSpecificAnyOf1) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.BardicInspirationDice) {
		toSerialize["bardic_inspiration_dice"] = o.BardicInspirationDice
	}
	if !isNil(o.SongOfRestDie) {
		toSerialize["song_of_rest_die"] = o.SongOfRestDie
	}
	if !isNil(o.MagicalSecretsMax5) {
		toSerialize["magical_secrets_max_5"] = o.MagicalSecretsMax5
	}
	if !isNil(o.MagicalSecretsMax7) {
		toSerialize["magical_secrets_max_7"] = o.MagicalSecretsMax7
	}
	if !isNil(o.MagicalSecretsMax9) {
		toSerialize["magical_secrets_max_9"] = o.MagicalSecretsMax9
	}
	return json.Marshal(toSerialize)
}

type NullableClassLevelClassSpecificAnyOf1 struct {
	value *ClassLevelClassSpecificAnyOf1
	isSet bool
}

func (v NullableClassLevelClassSpecificAnyOf1) Get() *ClassLevelClassSpecificAnyOf1 {
	return v.value
}

func (v *NullableClassLevelClassSpecificAnyOf1) Set(val *ClassLevelClassSpecificAnyOf1) {
	v.value = val
	v.isSet = true
}

func (v NullableClassLevelClassSpecificAnyOf1) IsSet() bool {
	return v.isSet
}

func (v *NullableClassLevelClassSpecificAnyOf1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClassLevelClassSpecificAnyOf1(val *ClassLevelClassSpecificAnyOf1) *NullableClassLevelClassSpecificAnyOf1 {
	return &NullableClassLevelClassSpecificAnyOf1{value: val, isSet: true}
}

func (v NullableClassLevelClassSpecificAnyOf1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClassLevelClassSpecificAnyOf1) UnmarshalJSON(src []byte) error {
	v.isSet = true
