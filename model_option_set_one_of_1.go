...
// OptionSetOneOf1 struct for OptionSetOneOf1
type OptionSetOneOf1 struct {
...
func (o OptionSetOneOf1) MarshalJSON() ([]byte, error) {
...
type NullableOptionSetOneOf1 struct {
	value *OptionSetOneOf1
	isSet bool
}

func (v NullableOptionSetOneOf1) Get() *OptionSetOneOf1 {
	return v.value
}

func (v *NullableOptionSetOneOf1) Set(val *OptionSetOneOf1) {
	v.value = val
	v.isSet = true
}

func (v NullableOptionSetOneOf1) IsSet() bool {
	return v.isSet
}

func (v *NullableOptionSetOneOf1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptionSetOneOf1(val *OptionSetOneOf1) *NullableOptionSetOneOf1 {
	return &NullableOptionSetOneOf1{value: val, isSet: true}
}

func (v NullableOptionSetOneOf1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptionSetOneOf1) UnmarshalJSON(src []byte) error {
	v.isSet = true
