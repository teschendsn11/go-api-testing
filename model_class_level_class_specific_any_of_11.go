...
// ClassLevelClassSpecificAnyOf11 Wizard Class Specific Features
type ClassLevelClassSpecificAnyOf11 struct {
...
func NewClassLevelClassSpecificAnyOf11() *ClassLevelClassSpecificAnyOf11 {
	this := ClassLevelClassSpecificAnyOf11{}
	return &this
}
...
// GetArcaneRecoverLevels returns the ArcaneRecoverLevels field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf11) GetArcaneRecoverLevels() float32 {
	if o == nil || isNil(o.ArcaneRecoverLevels) {
		var ret float32
		return ret
	}
	return *o.ArcaneRecoverLevels
}

// GetArcaneRecoverLevelsOk returns a tuple with the ArcaneRecoverLevels field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf11) GetArcaneRecoverLevelsOk() (*float32, bool) {
	if o == nil || isNil(o.ArcaneRecoverLevels) {
    return nil, false
	}
	return o.ArcaneRecoverLevels, true
}
...
// SetArcaneRecoverLevels gets a reference to the given float32 and assigns it to the ArcaneRecoverLevels field.
func (o *ClassLevelClassSpecificAnyOf11) SetArcaneRecoverLevels(v float32) {
	o.ArcaneRecoverLevels = &v
}

func (o ClassLevelClassSpecificAnyOf11) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.ArcaneRecoverLevels) {
		toSerialize["arcane_recover_levels"] = o.ArcaneRecoverLevels
	}
	return json.Marshal(toSerialize)
}

type NullableClassLevelClassSpecificAnyOf11 struct {
	value *ClassLevelClassSpecificAnyOf11
	isSet bool
}

func (v NullableClassLevelClassSpecificAnyOf11) Get() *ClassLevelClassSpecificAnyOf11 {
	return v.value
}

func (v *NullableClassLevelClassSpecificAnyOf11) Set(val *ClassLevelClassSpecificAnyOf11) {
	v.value = val
	v.isSet = true
}

func (v NullableClassLevelClassSpecificAnyOf11) IsSet() bool {
	return v.isSet
}

func (v *NullableClassLevelClassSpecificAnyOf11) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClassLevelClassSpecificAnyOf11(val *ClassLevelClassSpecificAnyOf11) *NullableClassLevelClassSpecificAnyOf11 {
	return &NullableClassLevelClassSpecificAnyOf11{value: val, isSet: true}
}

func (v NullableClassLevelClassSpecificAnyOf11) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClassLevelClassSpecificAnyOf11) UnmarshalJSON(src []byte) error {
	v.isSet = true
