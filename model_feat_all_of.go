...
// FeatAllOf struct for FeatAllOf
type FeatAllOf struct {
...
func (o FeatAllOf) MarshalJSON() ([]byte, error) {
...
type NullableFeatAllOf struct {
	value *FeatAllOf
	isSet bool
}

func (v NullableFeatAllOf) Get() *FeatAllOf {
	return v.value
}

func (v *NullableFeatAllOf) Set(val *FeatAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFeatAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFeatAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFeatAllOf(val *FeatAllOf) *NullableFeatAllOf {
	return &NullableFeatAllOf{value: val, isSet: true}
}

func (v NullableFeatAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFeatAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
