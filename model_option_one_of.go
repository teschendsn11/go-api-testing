...
// OptionOneOf struct for OptionOneOf
...
// SetItem gets a reference to the given APIReference and assigns it to the Item field.
func (o *OptionOneOf) SetItem(v APIReference) {
	o.Item = &v
}

func (o OptionOneOf) MarshalJSON() ([]byte, error) {
...
type NullableOptionOneOf struct {
	value *OptionOneOf
	isSet bool
}

func (v NullableOptionOneOf) Get() *OptionOneOf {
	return v.value
}

func (v *NullableOptionOneOf) Set(val *OptionOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableOptionOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableOptionOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptionOneOf(val *OptionOneOf) *NullableOptionOneOf {
	return &NullableOptionOneOf{value: val, isSet: true}
}

func (v NullableOptionOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptionOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
