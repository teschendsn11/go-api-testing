...
// ProficiencyAllOf struct for ProficiencyAllOf
type ProficiencyAllOf struct {
...
// SetReference gets a reference to the given APIReference and assigns it to the Reference field.
func (o *ProficiencyAllOf) SetReference(v APIReference) {
	o.Reference = &v
}

func (o ProficiencyAllOf) MarshalJSON() ([]byte, error) {
...
type NullableProficiencyAllOf struct {
	value *ProficiencyAllOf
	isSet bool
}

func (v NullableProficiencyAllOf) Get() *ProficiencyAllOf {
	return v.value
}

func (v *NullableProficiencyAllOf) Set(val *ProficiencyAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableProficiencyAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableProficiencyAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProficiencyAllOf(val *ProficiencyAllOf) *NullableProficiencyAllOf {
	return &NullableProficiencyAllOf{value: val, isSet: true}
}

func (v NullableProficiencyAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProficiencyAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
