...
func (o WeaponProperty) MarshalJSON() ([]byte, error) {
...
type NullableWeaponProperty struct {
	value *WeaponProperty
	isSet bool
}

func (v NullableWeaponProperty) Get() *WeaponProperty {
	return v.value
}

func (v *NullableWeaponProperty) Set(val *WeaponProperty) {
	v.value = val
	v.isSet = true
}

func (v NullableWeaponProperty) IsSet() bool {
	return v.isSet
}

func (v *NullableWeaponProperty) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWeaponProperty(val *WeaponProperty) *NullableWeaponProperty {
	return &NullableWeaponProperty{value: val, isSet: true}
}

func (v NullableWeaponProperty) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWeaponProperty) UnmarshalJSON(src []byte) error {
	v.isSet = true
