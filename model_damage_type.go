...
func (o DamageType) MarshalJSON() ([]byte, error) {
...
type NullableDamageType struct {
	value *DamageType
	isSet bool
}

func (v NullableDamageType) Get() *DamageType {
	return v.value
}

func (v *NullableDamageType) Set(val *DamageType) {
	v.value = val
	v.isSet = true
}

func (v NullableDamageType) IsSet() bool {
	return v.isSet
}

func (v *NullableDamageType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDamageType(val *DamageType) *NullableDamageType {
	return &NullableDamageType{value: val, isSet: true}
}

func (v NullableDamageType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDamageType) UnmarshalJSON(src []byte) error {
	v.isSet = true
