...
// MagicItemAllOfRarity struct for MagicItemAllOfRarity
type MagicItemAllOfRarity struct {
...
func (o MagicItemAllOfRarity) MarshalJSON() ([]byte, error) {
...
type NullableMagicItemAllOfRarity struct {
	value *MagicItemAllOfRarity
	isSet bool
}

func (v NullableMagicItemAllOfRarity) Get() *MagicItemAllOfRarity {
	return v.value
}

func (v *NullableMagicItemAllOfRarity) Set(val *MagicItemAllOfRarity) {
	v.value = val
	v.isSet = true
}

func (v NullableMagicItemAllOfRarity) IsSet() bool {
	return v.isSet
}

func (v *NullableMagicItemAllOfRarity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMagicItemAllOfRarity(val *MagicItemAllOfRarity) *NullableMagicItemAllOfRarity {
	return &NullableMagicItemAllOfRarity{value: val, isSet: true}
}

func (v NullableMagicItemAllOfRarity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMagicItemAllOfRarity) UnmarshalJSON(src []byte) error {
	v.isSet = true
