...
// ClassLevelClassSpecificAnyOf2 Cleric Class Specific Features
type ClassLevelClassSpecificAnyOf2 struct {
...
func NewClassLevelClassSpecificAnyOf2() *ClassLevelClassSpecificAnyOf2 {
	this := ClassLevelClassSpecificAnyOf2{}
	return &this
}
...
// GetChannelDivinityCharges returns the ChannelDivinityCharges field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf2) GetChannelDivinityCharges() float32 {
	if o == nil || isNil(o.ChannelDivinityCharges) {
		var ret float32
		return ret
	}
	return *o.ChannelDivinityCharges
}

// GetChannelDivinityChargesOk returns a tuple with the ChannelDivinityCharges field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf2) GetChannelDivinityChargesOk() (*float32, bool) {
	if o == nil || isNil(o.ChannelDivinityCharges) {
    return nil, false
	}
	return o.ChannelDivinityCharges, true
}
...
// SetChannelDivinityCharges gets a reference to the given float32 and assigns it to the ChannelDivinityCharges field.
func (o *ClassLevelClassSpecificAnyOf2) SetChannelDivinityCharges(v float32) {
	o.ChannelDivinityCharges = &v
}

// GetDestroyUndeadCr returns the DestroyUndeadCr field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf2) GetDestroyUndeadCr() float32 {
	if o == nil || isNil(o.DestroyUndeadCr) {
		var ret float32
		return ret
	}
	return *o.DestroyUndeadCr
}

// GetDestroyUndeadCrOk returns a tuple with the DestroyUndeadCr field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf2) GetDestroyUndeadCrOk() (*float32, bool) {
	if o == nil || isNil(o.DestroyUndeadCr) {
    return nil, false
	}
	return o.DestroyUndeadCr, true
}
...
// SetDestroyUndeadCr gets a reference to the given float32 and assigns it to the DestroyUndeadCr field.
func (o *ClassLevelClassSpecificAnyOf2) SetDestroyUndeadCr(v float32) {
	o.DestroyUndeadCr = &v
}

func (o ClassLevelClassSpecificAnyOf2) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.ChannelDivinityCharges) {
		toSerialize["channel_divinity_charges"] = o.ChannelDivinityCharges
	}
	if !isNil(o.DestroyUndeadCr) {
		toSerialize["destroy_undead_cr"] = o.DestroyUndeadCr
	}
	return json.Marshal(toSerialize)
}

type NullableClassLevelClassSpecificAnyOf2 struct {
	value *ClassLevelClassSpecificAnyOf2
	isSet bool
}

func (v NullableClassLevelClassSpecificAnyOf2) Get() *ClassLevelClassSpecificAnyOf2 {
	return v.value
}

func (v *NullableClassLevelClassSpecificAnyOf2) Set(val *ClassLevelClassSpecificAnyOf2) {
	v.value = val
	v.isSet = true
}

func (v NullableClassLevelClassSpecificAnyOf2) IsSet() bool {
	return v.isSet
}

func (v *NullableClassLevelClassSpecificAnyOf2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClassLevelClassSpecificAnyOf2(val *ClassLevelClassSpecificAnyOf2) *NullableClassLevelClassSpecificAnyOf2 {
	return &NullableClassLevelClassSpecificAnyOf2{value: val, isSet: true}
}

func (v NullableClassLevelClassSpecificAnyOf2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClassLevelClassSpecificAnyOf2) UnmarshalJSON(src []byte) error {
	v.isSet = true
