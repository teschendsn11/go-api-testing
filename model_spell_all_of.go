...
// SpellAllOf struct for SpellAllOf
type SpellAllOf struct {
	...
	Damage NullableOneOfDamageAtCharacterLevelDamageAtSlotLevel `json:"damage,omitempty"`
...
// GetDamage returns the Damage field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *SpellAllOf) GetDamage() OneOfDamageAtCharacterLevelDamageAtSlotLevel {
	if o == nil || isNil(o.Damage.Get()) {
		var ret OneOfDamageAtCharacterLevelDamageAtSlotLevel
		return ret
	}
	return *o.Damage.Get()
}
...
// SetDamage gets a reference to the given NullableOneOfDamageAtCharacterLevelDamageAtSlotLevel and assigns it to the Damage field.
...
func (o *SpellAllOf) SetDamageNil() {
	o.Damage.Set(nil)
}
...
func (o SpellAllOf) MarshalJSON() ([]byte, error) {
	...
	if o.Damage.IsSet() {
		toSerialize["damage"] = o.Damage.Get()
	}
	if !isNil(o.School) {
...
type NullableSpellAllOf struct {
	value *SpellAllOf
	isSet bool
}

func (v NullableSpellAllOf) Get() *SpellAllOf {
	return v.value
}

func (v *NullableSpellAllOf) Set(val *SpellAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSpellAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSpellAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpellAllOf(val *SpellAllOf) *NullableSpellAllOf {
	return &NullableSpellAllOf{value: val, isSet: true}
}

func (v NullableSpellAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpellAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
