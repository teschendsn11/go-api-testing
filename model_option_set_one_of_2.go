...
// OptionSetOneOf2 struct for OptionSetOneOf2
type OptionSetOneOf2 struct {
...
func (o OptionSetOneOf2) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.OptionSetType) {
		toSerialize["option_set_type"] = o.OptionSetType
	}
	if !isNil(o.ResourceList) {
		toSerialize["resource_list"] = o.ResourceList
	}
	return json.Marshal(toSerialize)
}

type NullableOptionSetOneOf2 struct {
	value *OptionSetOneOf2
	isSet bool
}

func (v NullableOptionSetOneOf2) Get() *OptionSetOneOf2 {
	return v.value
}

func (v *NullableOptionSetOneOf2) Set(val *OptionSetOneOf2) {
	v.value = val
	v.isSet = true
}

func (v NullableOptionSetOneOf2) IsSet() bool {
	return v.isSet
}

func (v *NullableOptionSetOneOf2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptionSetOneOf2(val *OptionSetOneOf2) *NullableOptionSetOneOf2 {
	return &NullableOptionSetOneOf2{value: val, isSet: true}
}

func (v NullableOptionSetOneOf2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptionSetOneOf2) UnmarshalJSON(src []byte) error {
	v.isSet = true
