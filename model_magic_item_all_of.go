...
// MagicItemAllOf struct for MagicItemAllOf
type MagicItemAllOf struct {
	EquipmentCategory *APIReference `json:"equipment_category,omitempty"`
	Rarity *MagicItemAllOfRarity `json:"rarity,omitempty"`
...
// SetRarity gets a reference to the given MagicItemAllOfRarity and assigns it to the Rarity field.
...
// SetVariants gets a reference to the given []APIReference and assigns it to the Variants field.
...
// SetVariant gets a reference to the given bool and assigns it to the Variant field.
func (o *MagicItemAllOf) SetVariant(v bool) {
	o.Variant = &v
}

func (o MagicItemAllOf) MarshalJSON() ([]byte, error) {
...
type NullableMagicItemAllOf struct {
	value *MagicItemAllOf
	isSet bool
}

func (v NullableMagicItemAllOf) Get() *MagicItemAllOf {
	return v.value
}

func (v *NullableMagicItemAllOf) Set(val *MagicItemAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableMagicItemAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableMagicItemAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMagicItemAllOf(val *MagicItemAllOf) *NullableMagicItemAllOf {
	return &NullableMagicItemAllOf{value: val, isSet: true}
}

func (v NullableMagicItemAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMagicItemAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
