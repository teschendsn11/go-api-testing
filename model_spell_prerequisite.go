...
// SpellPrerequisite `SpellPrerequisite` 
...
func (o SpellPrerequisite) MarshalJSON() ([]byte, error) {
...
type NullableSpellPrerequisite struct {
	value *SpellPrerequisite
	isSet bool
}

func (v NullableSpellPrerequisite) Get() *SpellPrerequisite {
	return v.value
}

func (v *NullableSpellPrerequisite) Set(val *SpellPrerequisite) {
	v.value = val
	v.isSet = true
}

func (v NullableSpellPrerequisite) IsSet() bool {
	return v.isSet
}

func (v *NullableSpellPrerequisite) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpellPrerequisite(val *SpellPrerequisite) *NullableSpellPrerequisite {
	return &NullableSpellPrerequisite{value: val, isSet: true}
}

func (v NullableSpellPrerequisite) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpellPrerequisite) UnmarshalJSON(src []byte) error {
	v.isSet = true
