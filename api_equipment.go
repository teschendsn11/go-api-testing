...
type ApiApiEquipmentCategoriesIndexGetRequest struct {
	ctx context.Context
	ApiService *EquipmentApiService
	index string
}

func (r ApiApiEquipmentCategoriesIndexGetRequest) Execute() (*EquipmentCategory, *http.Response, error) {
	return r.ApiService.ApiEquipmentCategoriesIndexGetExecute(r)
}

/*
ApiEquipmentCategoriesIndexGet Get an equipment category by index.

These are the categories that various equipment fall under.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the equipment category score to get.  Available values can be found in the resource list for this endpoint. 
 @return ApiApiEquipmentCategoriesIndexGetRequest
*/
func (a *EquipmentApiService) ApiEquipmentCategoriesIndexGet(ctx context.Context, index string) ApiApiEquipmentCategoriesIndexGetRequest {
	return ApiApiEquipmentCategoriesIndexGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
func (a *EquipmentApiService) ApiEquipmentCategoriesIndexGetExecute(r ApiApiEquipmentCategoriesIndexGetRequest) (*EquipmentCategory, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *EquipmentCategory
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EquipmentApiService.ApiEquipmentCategoriesIndexGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/equipment-categories/{index}"
...
type ApiApiEquipmentIndexGetRequest struct {
	ctx context.Context
	ApiService *EquipmentApiService
	index string
}

func (r ApiApiEquipmentIndexGetRequest) Execute() (*Equipment, *http.Response, error) {
	return r.ApiService.ApiEquipmentIndexGetExecute(r)
}

/*
ApiEquipmentIndexGet Get an equipment item by index.
...
can find buyers and merchants interested in your loot.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the equipment to get.  Available values can be found in the [`ResourceList`](#get-/api/-endpoint-) for `equipment`. 
 @return ApiApiEquipmentIndexGetRequest
*/
func (a *EquipmentApiService) ApiEquipmentIndexGet(ctx context.Context, index string) ApiApiEquipmentIndexGetRequest {
	return ApiApiEquipmentIndexGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
// Execute executes the request
//  @return Equipment
func (a *EquipmentApiService) ApiEquipmentIndexGetExecute(r ApiApiEquipmentIndexGetRequest) (*Equipment, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EquipmentApiService.ApiEquipmentIndexGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/equipment/{index}"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
...
type ApiApiMagicItemsIndexGetRequest struct {
	ctx context.Context
	ApiService *EquipmentApiService
	index string
}

func (r ApiApiMagicItemsIndexGetRequest) Execute() (*MagicItem, *http.Response, error) {
	return r.ApiService.ApiMagicItemsIndexGetExecute(r)
}

/*
ApiMagicItemsIndexGet Get a magic item by index.

These are the various magic items you can find in the game.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the magic item to get.  Available values can be found in the resource list for this endpoint. 
 @return ApiApiMagicItemsIndexGetRequest
*/
func (a *EquipmentApiService) ApiMagicItemsIndexGet(ctx context.Context, index string) ApiApiMagicItemsIndexGetRequest {
	return ApiApiMagicItemsIndexGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
// Execute executes the request
//  @return MagicItem
func (a *EquipmentApiService) ApiMagicItemsIndexGetExecute(r ApiApiMagicItemsIndexGetRequest) (*MagicItem, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MagicItem
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EquipmentApiService.ApiMagicItemsIndexGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/magic-items/{index}"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
...
type ApiApiWeaponPropertiesIndexGetRequest struct {
	ctx context.Context
	ApiService *EquipmentApiService
	index string
}

func (r ApiApiWeaponPropertiesIndexGetRequest) Execute() (*WeaponProperty, *http.Response, error) {
	return r.ApiService.ApiWeaponPropertiesIndexGetExecute(r)
}

/*
ApiWeaponPropertiesIndexGet Get a weapon property by index.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the weapon property to get. 
 @return ApiApiWeaponPropertiesIndexGetRequest
*/
func (a *EquipmentApiService) ApiWeaponPropertiesIndexGet(ctx context.Context, index string) ApiApiWeaponPropertiesIndexGetRequest {
	return ApiApiWeaponPropertiesIndexGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
func (a *EquipmentApiService) ApiWeaponPropertiesIndexGetExecute(r ApiApiWeaponPropertiesIndexGetRequest) (*WeaponProperty, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *WeaponProperty
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EquipmentApiService.ApiWeaponPropertiesIndexGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/weapon-properties/{index}"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
