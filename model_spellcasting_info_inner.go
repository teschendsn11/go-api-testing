...
// SpellcastingInfoInner struct for SpellcastingInfoInner
type SpellcastingInfoInner struct {
	// Feature name.
...
func (o SpellcastingInfoInner) MarshalJSON() ([]byte, error) {
...
type NullableSpellcastingInfoInner struct {
	value *SpellcastingInfoInner
	isSet bool
}

func (v NullableSpellcastingInfoInner) Get() *SpellcastingInfoInner {
	return v.value
}

func (v *NullableSpellcastingInfoInner) Set(val *SpellcastingInfoInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSpellcastingInfoInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSpellcastingInfoInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpellcastingInfoInner(val *SpellcastingInfoInner) *NullableSpellcastingInfoInner {
	return &NullableSpellcastingInfoInner{value: val, isSet: true}
}

func (v NullableSpellcastingInfoInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpellcastingInfoInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
