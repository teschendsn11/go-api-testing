...
// OptionOneOf9 struct for OptionOneOf9
type OptionOneOf9 struct {
...
func (o OptionOneOf9) MarshalJSON() ([]byte, error) {
...
type NullableOptionOneOf9 struct {
	value *OptionOneOf9
	isSet bool
}

func (v NullableOptionOneOf9) Get() *OptionOneOf9 {
	return v.value
}

func (v *NullableOptionOneOf9) Set(val *OptionOneOf9) {
	v.value = val
	v.isSet = true
}

func (v NullableOptionOneOf9) IsSet() bool {
	return v.isSet
}

func (v *NullableOptionOneOf9) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptionOneOf9(val *OptionOneOf9) *NullableOptionOneOf9 {
	return &NullableOptionOneOf9{value: val, isSet: true}
}

func (v NullableOptionOneOf9) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptionOneOf9) UnmarshalJSON(src []byte) error {
	v.isSet = true
