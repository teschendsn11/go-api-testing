...
// EquipmentPackAllOf struct for EquipmentPackAllOf
type EquipmentPackAllOf struct {
...
func (o EquipmentPackAllOf) MarshalJSON() ([]byte, error) {
...
type NullableEquipmentPackAllOf struct {
	value *EquipmentPackAllOf
	isSet bool
}

func (v NullableEquipmentPackAllOf) Get() *EquipmentPackAllOf {
	return v.value
}

func (v *NullableEquipmentPackAllOf) Set(val *EquipmentPackAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableEquipmentPackAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableEquipmentPackAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEquipmentPackAllOf(val *EquipmentPackAllOf) *NullableEquipmentPackAllOf {
	return &NullableEquipmentPackAllOf{value: val, isSet: true}
}

func (v NullableEquipmentPackAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEquipmentPackAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
