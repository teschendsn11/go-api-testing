...
// OptionOneOf4 struct for OptionOneOf4
type OptionOneOf4 struct {
...
func (o OptionOneOf4) MarshalJSON() ([]byte, error) {
...
type NullableOptionOneOf4 struct {
	value *OptionOneOf4
	isSet bool
}

func (v NullableOptionOneOf4) Get() *OptionOneOf4 {
	return v.value
}

func (v *NullableOptionOneOf4) Set(val *OptionOneOf4) {
	v.value = val
	v.isSet = true
}

func (v NullableOptionOneOf4) IsSet() bool {
	return v.isSet
}

func (v *NullableOptionOneOf4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptionOneOf4(val *OptionOneOf4) *NullableOptionOneOf4 {
	return &NullableOptionOneOf4{value: val, isSet: true}
}

func (v NullableOptionOneOf4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptionOneOf4) UnmarshalJSON(src []byte) error {
	v.isSet = true
