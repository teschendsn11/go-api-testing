...
// PrerequisiteAbilityScore struct for PrerequisiteAbilityScore
type PrerequisiteAbilityScore struct {
...
func (o PrerequisiteAbilityScore) MarshalJSON() ([]byte, error) {
...
type NullablePrerequisiteAbilityScore struct {
	value *PrerequisiteAbilityScore
	isSet bool
}

func (v NullablePrerequisiteAbilityScore) Get() *PrerequisiteAbilityScore {
	return v.value
}

func (v *NullablePrerequisiteAbilityScore) Set(val *PrerequisiteAbilityScore) {
	v.value = val
	v.isSet = true
}

func (v NullablePrerequisiteAbilityScore) IsSet() bool {
	return v.isSet
}

func (v *NullablePrerequisiteAbilityScore) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrerequisiteAbilityScore(val *PrerequisiteAbilityScore) *NullablePrerequisiteAbilityScore {
	return &NullablePrerequisiteAbilityScore{value: val, isSet: true}
}

func (v NullablePrerequisiteAbilityScore) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrerequisiteAbilityScore) UnmarshalJSON(src []byte) error {
	v.isSet = true
