...
// WeaponAllOf struct for WeaponAllOf
type WeaponAllOf struct {
...
func (o WeaponAllOf) MarshalJSON() ([]byte, error) {
...
type NullableWeaponAllOf struct {
	value *WeaponAllOf
	isSet bool
}

func (v NullableWeaponAllOf) Get() *WeaponAllOf {
	return v.value
}

func (v *NullableWeaponAllOf) Set(val *WeaponAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableWeaponAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableWeaponAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWeaponAllOf(val *WeaponAllOf) *NullableWeaponAllOf {
	return &NullableWeaponAllOf{value: val, isSet: true}
}

func (v NullableWeaponAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWeaponAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
