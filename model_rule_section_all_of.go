...
// RuleSectionAllOf struct for RuleSectionAllOf
type RuleSectionAllOf struct {
...
func (o RuleSectionAllOf) MarshalJSON() ([]byte, error) {
...
type NullableRuleSectionAllOf struct {
	value *RuleSectionAllOf
	isSet bool
}

func (v NullableRuleSectionAllOf) Get() *RuleSectionAllOf {
	return v.value
}

func (v *NullableRuleSectionAllOf) Set(val *RuleSectionAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableRuleSectionAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableRuleSectionAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuleSectionAllOf(val *RuleSectionAllOf) *NullableRuleSectionAllOf {
	return &NullableRuleSectionAllOf{value: val, isSet: true}
}

func (v NullableRuleSectionAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuleSectionAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
