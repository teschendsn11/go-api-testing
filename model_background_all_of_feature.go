...
// BackgroundAllOfFeature Special feature granted to new characters of this background.
type BackgroundAllOfFeature struct {
...
func (o BackgroundAllOfFeature) MarshalJSON() ([]byte, error) {
...
type NullableBackgroundAllOfFeature struct {
	value *BackgroundAllOfFeature
	isSet bool
}

func (v NullableBackgroundAllOfFeature) Get() *BackgroundAllOfFeature {
	return v.value
}

func (v *NullableBackgroundAllOfFeature) Set(val *BackgroundAllOfFeature) {
	v.value = val
	v.isSet = true
}

func (v NullableBackgroundAllOfFeature) IsSet() bool {
	return v.isSet
}

func (v *NullableBackgroundAllOfFeature) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBackgroundAllOfFeature(val *BackgroundAllOfFeature) *NullableBackgroundAllOfFeature {
	return &NullableBackgroundAllOfFeature{value: val, isSet: true}
}

func (v NullableBackgroundAllOfFeature) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBackgroundAllOfFeature) UnmarshalJSON(src []byte) error {
	v.isSet = true
