...
// SubclassAllOf struct for SubclassAllOf
type SubclassAllOf struct {
...
func (o SubclassAllOf) MarshalJSON() ([]byte, error) {
...
type NullableSubclassAllOf struct {
	value *SubclassAllOf
	isSet bool
}

func (v NullableSubclassAllOf) Get() *SubclassAllOf {
	return v.value
}

func (v *NullableSubclassAllOf) Set(val *SubclassAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSubclassAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSubclassAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubclassAllOf(val *SubclassAllOf) *NullableSubclassAllOf {
	return &NullableSubclassAllOf{value: val, isSet: true}
}

func (v NullableSubclassAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubclassAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
