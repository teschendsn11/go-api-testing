...
// OptionOneOf10 struct for OptionOneOf10
type OptionOneOf10 struct {
...
// GetDamageDice returns the DamageDice field value if set, zero value otherwise.
func (o *OptionOneOf10) GetDamageDice() string {
	if o == nil || isNil(o.DamageDice) {
		var ret string
		return ret
	}
	return *o.DamageDice
...
// GetDamageDiceOk returns a tuple with the DamageDice field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OptionOneOf10) GetDamageDiceOk() (*string, bool) {
	if o == nil || isNil(o.DamageDice) {
    return nil, false
	}
	return o.DamageDice, true
}
...
// SetDamageDice gets a reference to the given string and assigns it to the DamageDice field.
...
func (o OptionOneOf10) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.DamageDice) {
		toSerialize["damage_dice"] = o.DamageDice
	}
	if !isNil(o.Notes) {
...
type NullableOptionOneOf10 struct {
	value *OptionOneOf10
	isSet bool
}

func (v NullableOptionOneOf10) Get() *OptionOneOf10 {
	return v.value
}

func (v *NullableOptionOneOf10) Set(val *OptionOneOf10) {
	v.value = val
	v.isSet = true
}

func (v NullableOptionOneOf10) IsSet() bool {
	return v.isSet
}

func (v *NullableOptionOneOf10) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptionOneOf10(val *OptionOneOf10) *NullableOptionOneOf10 {
	return &NullableOptionOneOf10{value: val, isSet: true}
}

func (v NullableOptionOneOf10) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptionOneOf10) UnmarshalJSON(src []byte) error {
	v.isSet = true
