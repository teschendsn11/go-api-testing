...
func (o Gear) MarshalJSON() ([]byte, error) {
...
type NullableGear struct {
	value *Gear
	isSet bool
}

func (v NullableGear) Get() *Gear {
	return v.value
}

func (v *NullableGear) Set(val *Gear) {
	v.value = val
	v.isSet = true
}

func (v NullableGear) IsSet() bool {
	return v.isSet
}

func (v *NullableGear) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGear(val *Gear) *NullableGear {
	return &NullableGear{value: val, isSet: true}
}

func (v NullableGear) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGear) UnmarshalJSON(src []byte) error {
	v.isSet = true
