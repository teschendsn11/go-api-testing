...
// ClassResourceListsApiService ClassResourceListsApi service
type ClassResourceListsApiService service

type ApiApiClassesIndexFeaturesGetRequest struct {
	ctx context.Context
	ApiService *ClassResourceListsApiService
	index string
}

func (r ApiApiClassesIndexFeaturesGetRequest) Execute() (*APIReferenceList, *http.Response, error) {
	return r.ApiService.ApiClassesIndexFeaturesGetExecute(r)
}

/*
ApiClassesIndexFeaturesGet Get features available for a class.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the class to get. 
 @return ApiApiClassesIndexFeaturesGetRequest
*/
func (a *ClassResourceListsApiService) ApiClassesIndexFeaturesGet(ctx context.Context, index string) ApiApiClassesIndexFeaturesGetRequest {
	return ApiApiClassesIndexFeaturesGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
func (a *ClassResourceListsApiService) ApiClassesIndexFeaturesGetExecute(r ApiApiClassesIndexFeaturesGetRequest) (*APIReferenceList, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClassResourceListsApiService.ApiClassesIndexFeaturesGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/classes/{index}/features"
...
type ApiApiClassesIndexProficienciesGetRequest struct {
	ctx context.Context
	ApiService *ClassResourceListsApiService
	index string
}

func (r ApiApiClassesIndexProficienciesGetRequest) Execute() (*APIReferenceList, *http.Response, error) {
	return r.ApiService.ApiClassesIndexProficienciesGetExecute(r)
}

/*
ApiClassesIndexProficienciesGet Get proficiencies available for a class.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the class to get. 
 @return ApiApiClassesIndexProficienciesGetRequest
*/
func (a *ClassResourceListsApiService) ApiClassesIndexProficienciesGet(ctx context.Context, index string) ApiApiClassesIndexProficienciesGetRequest {
	return ApiApiClassesIndexProficienciesGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
// Execute executes the request
//  @return APIReferenceList
func (a *ClassResourceListsApiService) ApiClassesIndexProficienciesGetExecute(r ApiApiClassesIndexProficienciesGetRequest) (*APIReferenceList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClassResourceListsApiService.ApiClassesIndexProficienciesGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/classes/{index}/proficiencies"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
...
type ApiApiClassesIndexSpellsGetRequest struct {
	ctx context.Context
	ApiService *ClassResourceListsApiService
	index string
}

func (r ApiApiClassesIndexSpellsGetRequest) Execute() (*APIReferenceList, *http.Response, error) {
	return r.ApiService.ApiClassesIndexSpellsGetExecute(r)
}

/*
ApiClassesIndexSpellsGet Get spells available for a class.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the class to get. 
 @return ApiApiClassesIndexSpellsGetRequest
*/
func (a *ClassResourceListsApiService) ApiClassesIndexSpellsGet(ctx context.Context, index string) ApiApiClassesIndexSpellsGetRequest {
	return ApiApiClassesIndexSpellsGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
// Execute executes the request
//  @return APIReferenceList
func (a *ClassResourceListsApiService) ApiClassesIndexSpellsGetExecute(r ApiApiClassesIndexSpellsGetRequest) (*APIReferenceList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClassResourceListsApiService.ApiClassesIndexSpellsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/classes/{index}/spells"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
...
type ApiApiClassesIndexSubclassesGetRequest struct {
	ctx context.Context
	ApiService *ClassResourceListsApiService
	index string
}

func (r ApiApiClassesIndexSubclassesGetRequest) Execute() (*APIReferenceList, *http.Response, error) {
	return r.ApiService.ApiClassesIndexSubclassesGetExecute(r)
}

/*
ApiClassesIndexSubclassesGet Get subclasses available for a class.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the class to get. 
 @return ApiApiClassesIndexSubclassesGetRequest
*/
func (a *ClassResourceListsApiService) ApiClassesIndexSubclassesGet(ctx context.Context, index string) ApiApiClassesIndexSubclassesGetRequest {
	return ApiApiClassesIndexSubclassesGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
// Execute executes the request
//  @return APIReferenceList
func (a *ClassResourceListsApiService) ApiClassesIndexSubclassesGetExecute(r ApiApiClassesIndexSubclassesGetRequest) (*APIReferenceList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClassResourceListsApiService.ApiClassesIndexSubclassesGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/classes/{index}/subclasses"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
