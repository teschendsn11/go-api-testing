...
// ClassLevelsApiService ClassLevelsApi service
type ClassLevelsApiService service

type ApiApiClassesIndexLevelsClassLevelFeaturesGetRequest struct {
	ctx context.Context
	ApiService *ClassLevelsApiService
	index string
	classLevel float32
}

func (r ApiApiClassesIndexLevelsClassLevelFeaturesGetRequest) Execute() (*APIReferenceList, *http.Response, error) {
	return r.ApiService.ApiClassesIndexLevelsClassLevelFeaturesGetExecute(r)
}

/*
ApiClassesIndexLevelsClassLevelFeaturesGet Get features available to a class at the requested level.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the class to get. 
 @param classLevel
 @return ApiApiClassesIndexLevelsClassLevelFeaturesGetRequest
*/
func (a *ClassLevelsApiService) ApiClassesIndexLevelsClassLevelFeaturesGet(ctx context.Context, index string, classLevel float32) ApiApiClassesIndexLevelsClassLevelFeaturesGetRequest {
	return ApiApiClassesIndexLevelsClassLevelFeaturesGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
func (a *ClassLevelsApiService) ApiClassesIndexLevelsClassLevelFeaturesGetExecute(r ApiApiClassesIndexLevelsClassLevelFeaturesGetRequest) (*APIReferenceList, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClassLevelsApiService.ApiClassesIndexLevelsClassLevelFeaturesGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/classes/{index}/levels/{class_level}/features"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"class_level"+"}", url.PathEscape(parameterToString(r.classLevel, "")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.classLevel < 0 {
		return localVarReturnValue, nil, reportError("classLevel must be greater than 0")
	}
	if r.classLevel > 20 {
		return localVarReturnValue, nil, reportError("classLevel must be less than 20")
	}
...
type ApiApiClassesIndexLevelsClassLevelGetRequest struct {
	ctx context.Context
	ApiService *ClassLevelsApiService
	index string
	classLevel float32
...
func (r ApiApiClassesIndexLevelsClassLevelGetRequest) Execute() (*ClassLevel, *http.Response, error) {
	return r.ApiService.ApiClassesIndexLevelsClassLevelGetExecute(r)
}

/*
ApiClassesIndexLevelsClassLevelGet Get level resource for a class and level.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the class to get. 
 @param classLevel
 @return ApiApiClassesIndexLevelsClassLevelGetRequest
*/
func (a *ClassLevelsApiService) ApiClassesIndexLevelsClassLevelGet(ctx context.Context, index string, classLevel float32) ApiApiClassesIndexLevelsClassLevelGetRequest {
	return ApiApiClassesIndexLevelsClassLevelGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
// Execute executes the request
//  @return ClassLevel
func (a *ClassLevelsApiService) ApiClassesIndexLevelsClassLevelGetExecute(r ApiApiClassesIndexLevelsClassLevelGetRequest) (*ClassLevel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ClassLevel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClassLevelsApiService.ApiClassesIndexLevelsClassLevelGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/classes/{index}/levels/{class_level}"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"class_level"+"}", url.PathEscape(parameterToString(r.classLevel, "")), -1)
...
type ApiApiClassesIndexLevelsGetRequest struct {
	ctx context.Context
	ApiService *ClassLevelsApiService
	index string
	subclass *string
...
func (r ApiApiClassesIndexLevelsGetRequest) Subclass(subclass string) ApiApiClassesIndexLevelsGetRequest {
	r.subclass = &subclass
	return r
}

func (r ApiApiClassesIndexLevelsGetRequest) Execute() ([]ClassLevel, *http.Response, error) {
	return r.ApiService.ApiClassesIndexLevelsGetExecute(r)
}

/*
ApiClassesIndexLevelsGet Get all level resources for a class.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the class to get. 
 @return ApiApiClassesIndexLevelsGetRequest
*/
func (a *ClassLevelsApiService) ApiClassesIndexLevelsGet(ctx context.Context, index string) ApiApiClassesIndexLevelsGetRequest {
	return ApiApiClassesIndexLevelsGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
// Execute executes the request
//  @return []ClassLevel
func (a *ClassLevelsApiService) ApiClassesIndexLevelsGetExecute(r ApiApiClassesIndexLevelsGetRequest) ([]ClassLevel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClassLevelsApiService.ApiClassesIndexLevelsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/classes/{index}/levels"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
	...
	if r.subclass != nil {
		localVarQueryParams.Add("subclass", parameterToString(*r.subclass, ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
type ApiApiClassesIndexLevelsSpellLevelSpellsGetRequest struct {
	ctx context.Context
	ApiService *ClassLevelsApiService
	index string
	spellLevel float32
...
func (r ApiApiClassesIndexLevelsSpellLevelSpellsGetRequest) Execute() (*APIReferenceList, *http.Response, error) {
	return r.ApiService.ApiClassesIndexLevelsSpellLevelSpellsGetExecute(r)
}

/*
ApiClassesIndexLevelsSpellLevelSpellsGet Get spells of the requested level available to the class.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the class to get. 
 @param spellLevel
 @return ApiApiClassesIndexLevelsSpellLevelSpellsGetRequest
*/
func (a *ClassLevelsApiService) ApiClassesIndexLevelsSpellLevelSpellsGet(ctx context.Context, index string, spellLevel float32) ApiApiClassesIndexLevelsSpellLevelSpellsGetRequest {
	return ApiApiClassesIndexLevelsSpellLevelSpellsGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
// Execute executes the request
//  @return APIReferenceList
func (a *ClassLevelsApiService) ApiClassesIndexLevelsSpellLevelSpellsGetExecute(r ApiApiClassesIndexLevelsSpellLevelSpellsGetRequest) (*APIReferenceList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClassLevelsApiService.ApiClassesIndexLevelsSpellLevelSpellsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/classes/{index}/levels/{spell_level}/spells"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"spell_level"+"}", url.PathEscape(parameterToString(r.spellLevel, "")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.spellLevel < 1 {
		return localVarReturnValue, nil, reportError("spellLevel must be greater than 1")
	}
	if r.spellLevel > 9 {
		return localVarReturnValue, nil, reportError("spellLevel must be less than 9")
	}
