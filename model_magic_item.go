...
func (o MagicItem) MarshalJSON() ([]byte, error) {
...
type NullableMagicItem struct {
	value *MagicItem
	isSet bool
}

func (v NullableMagicItem) Get() *MagicItem {
	return v.value
}

func (v *NullableMagicItem) Set(val *MagicItem) {
	v.value = val
	v.isSet = true
}

func (v NullableMagicItem) IsSet() bool {
	return v.isSet
}

func (v *NullableMagicItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMagicItem(val *MagicItem) *NullableMagicItem {
	return &NullableMagicItem{value: val, isSet: true}
}

func (v NullableMagicItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMagicItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
