...
func (o EquipmentCategory) MarshalJSON() ([]byte, error) {
...
type NullableEquipmentCategory struct {
	value *EquipmentCategory
	isSet bool
}

func (v NullableEquipmentCategory) Get() *EquipmentCategory {
	return v.value
}

func (v *NullableEquipmentCategory) Set(val *EquipmentCategory) {
	v.value = val
	v.isSet = true
}

func (v NullableEquipmentCategory) IsSet() bool {
	return v.isSet
}

func (v *NullableEquipmentCategory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEquipmentCategory(val *EquipmentCategory) *NullableEquipmentCategory {
	return &NullableEquipmentCategory{value: val, isSet: true}
}

func (v NullableEquipmentCategory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEquipmentCategory) UnmarshalJSON(src []byte) error {
	v.isSet = true
