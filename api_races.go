...
// RacesApiService RacesApi service
type RacesApiService service

type ApiApiRacesIndexGetRequest struct {
	ctx context.Context
	ApiService *RacesApiService
	index string
}

func (r ApiApiRacesIndexGetRequest) Execute() (*Race, *http.Response, error) {
	return r.ApiService.ApiRacesIndexGetExecute(r)
}

/*
ApiRacesIndexGet Get a race by index.
...
Each race grants your character ability and skill bonuses as well as racial traits.
 ...
 @return ApiApiRacesIndexGetRequest
*/
func (a *RacesApiService) ApiRacesIndexGet(ctx context.Context, index string) ApiApiRacesIndexGetRequest {
	return ApiApiRacesIndexGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
//  @return Race
func (a *RacesApiService) ApiRacesIndexGetExecute(r ApiApiRacesIndexGetRequest) (*Race, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *Race
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RacesApiService.ApiRacesIndexGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/races/{index}"
...
type ApiApiRacesIndexProficienciesGetRequest struct {
	ctx context.Context
	ApiService *RacesApiService
	index string
}

func (r ApiApiRacesIndexProficienciesGetRequest) Execute() (*APIReferenceList, *http.Response, error) {
	return r.ApiService.ApiRacesIndexProficienciesGetExecute(r)
}

/*
ApiRacesIndexProficienciesGet Get proficiencies available for a race.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the race to get. 
 @return ApiApiRacesIndexProficienciesGetRequest
*/
func (a *RacesApiService) ApiRacesIndexProficienciesGet(ctx context.Context, index string) ApiApiRacesIndexProficienciesGetRequest {
	return ApiApiRacesIndexProficienciesGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
func (a *RacesApiService) ApiRacesIndexProficienciesGetExecute(r ApiApiRacesIndexProficienciesGetRequest) (*APIReferenceList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RacesApiService.ApiRacesIndexProficienciesGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/races/{index}/proficiencies"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
...
type ApiApiRacesIndexSubracesGetRequest struct {
	ctx context.Context
	ApiService *RacesApiService
	index string
}

func (r ApiApiRacesIndexSubracesGetRequest) Execute() (*APIReferenceList, *http.Response, error) {
	return r.ApiService.ApiRacesIndexSubracesGetExecute(r)
}

/*
ApiRacesIndexSubracesGet Get subraces available for a race.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the race to get. 
 @return ApiApiRacesIndexSubracesGetRequest
*/
func (a *RacesApiService) ApiRacesIndexSubracesGet(ctx context.Context, index string) ApiApiRacesIndexSubracesGetRequest {
	return ApiApiRacesIndexSubracesGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
// Execute executes the request
//  @return APIReferenceList
func (a *RacesApiService) ApiRacesIndexSubracesGetExecute(r ApiApiRacesIndexSubracesGetRequest) (*APIReferenceList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RacesApiService.ApiRacesIndexSubracesGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/races/{index}/subraces"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
...
type ApiApiRacesIndexTraitsGetRequest struct {
	ctx context.Context
	ApiService *RacesApiService
	index string
}

func (r ApiApiRacesIndexTraitsGetRequest) Execute() (*APIReferenceList, *http.Response, error) {
	return r.ApiService.ApiRacesIndexTraitsGetExecute(r)
}

/*
ApiRacesIndexTraitsGet Get traits available for a race.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the race to get. 
 @return ApiApiRacesIndexTraitsGetRequest
*/
func (a *RacesApiService) ApiRacesIndexTraitsGet(ctx context.Context, index string) ApiApiRacesIndexTraitsGetRequest {
	return ApiApiRacesIndexTraitsGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
// Execute executes the request
//  @return APIReferenceList
func (a *RacesApiService) ApiRacesIndexTraitsGetExecute(r ApiApiRacesIndexTraitsGetRequest) (*APIReferenceList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RacesApiService.ApiRacesIndexTraitsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/races/{index}/traits"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
