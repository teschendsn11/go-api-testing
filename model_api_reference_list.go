...
// SetResults gets a reference to the given []APIReference and assigns it to the Results field.
func (o *APIReferenceList) SetResults(v []APIReference) {
	o.Results = v
}

func (o APIReferenceList) MarshalJSON() ([]byte, error) {
...
type NullableAPIReferenceList struct {
	value *APIReferenceList
	isSet bool
}

func (v NullableAPIReferenceList) Get() *APIReferenceList {
	return v.value
}

func (v *NullableAPIReferenceList) Set(val *APIReferenceList) {
	v.value = val
	v.isSet = true
}

func (v NullableAPIReferenceList) IsSet() bool {
	return v.isSet
}

func (v *NullableAPIReferenceList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAPIReferenceList(val *APIReferenceList) *NullableAPIReferenceList {
	return &NullableAPIReferenceList{value: val, isSet: true}
}

func (v NullableAPIReferenceList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAPIReferenceList) UnmarshalJSON(src []byte) error {
	v.isSet = true
