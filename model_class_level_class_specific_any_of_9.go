...
// ClassLevelClassSpecificAnyOf9 Bard Sorcerer Specific Features
type ClassLevelClassSpecificAnyOf9 struct {
	SorceryPoints *float32 `json:"sorcery_points,omitempty"`
	MetamagicKnown *float32 `json:"metamagic_known,omitempty"`
	CreatingSpellSlots []ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner `json:"creating_spell_slots,omitempty"`
}
...
func NewClassLevelClassSpecificAnyOf9() *ClassLevelClassSpecificAnyOf9 {
	this := ClassLevelClassSpecificAnyOf9{}
	return &this
}
...
// GetSorceryPoints returns the SorceryPoints field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf9) GetSorceryPoints() float32 {
	if o == nil || isNil(o.SorceryPoints) {
		var ret float32
		return ret
	}
	return *o.SorceryPoints
}

// GetSorceryPointsOk returns a tuple with the SorceryPoints field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf9) GetSorceryPointsOk() (*float32, bool) {
	if o == nil || isNil(o.SorceryPoints) {
    return nil, false
	}
	return o.SorceryPoints, true
}
...
// SetSorceryPoints gets a reference to the given float32 and assigns it to the SorceryPoints field.
func (o *ClassLevelClassSpecificAnyOf9) SetSorceryPoints(v float32) {
	o.SorceryPoints = &v
}

// GetMetamagicKnown returns the MetamagicKnown field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf9) GetMetamagicKnown() float32 {
	if o == nil || isNil(o.MetamagicKnown) {
		var ret float32
		return ret
	}
	return *o.MetamagicKnown
}

// GetMetamagicKnownOk returns a tuple with the MetamagicKnown field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf9) GetMetamagicKnownOk() (*float32, bool) {
	if o == nil || isNil(o.MetamagicKnown) {
    return nil, false
	}
	return o.MetamagicKnown, true
}
...
// SetMetamagicKnown gets a reference to the given float32 and assigns it to the MetamagicKnown field.
func (o *ClassLevelClassSpecificAnyOf9) SetMetamagicKnown(v float32) {
	o.MetamagicKnown = &v
}

// GetCreatingSpellSlots returns the CreatingSpellSlots field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf9) GetCreatingSpellSlots() []ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner {
	if o == nil || isNil(o.CreatingSpellSlots) {
		var ret []ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner
		return ret
	}
	return o.CreatingSpellSlots
}

// GetCreatingSpellSlotsOk returns a tuple with the CreatingSpellSlots field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf9) GetCreatingSpellSlotsOk() ([]ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner, bool) {
	if o == nil || isNil(o.CreatingSpellSlots) {
    return nil, false
	}
	return o.CreatingSpellSlots, true
}
...
// SetCreatingSpellSlots gets a reference to the given []ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner and assigns it to the CreatingSpellSlots field.
func (o *ClassLevelClassSpecificAnyOf9) SetCreatingSpellSlots(v []ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner) {
	o.CreatingSpellSlots = v
}

func (o ClassLevelClassSpecificAnyOf9) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.SorceryPoints) {
		toSerialize["sorcery_points"] = o.SorceryPoints
	}
	if !isNil(o.MetamagicKnown) {
		toSerialize["metamagic_known"] = o.MetamagicKnown
	}
	if !isNil(o.CreatingSpellSlots) {
		toSerialize["creating_spell_slots"] = o.CreatingSpellSlots
	}
	return json.Marshal(toSerialize)
}

type NullableClassLevelClassSpecificAnyOf9 struct {
	value *ClassLevelClassSpecificAnyOf9
	isSet bool
}

func (v NullableClassLevelClassSpecificAnyOf9) Get() *ClassLevelClassSpecificAnyOf9 {
	return v.value
}

func (v *NullableClassLevelClassSpecificAnyOf9) Set(val *ClassLevelClassSpecificAnyOf9) {
	v.value = val
	v.isSet = true
}

func (v NullableClassLevelClassSpecificAnyOf9) IsSet() bool {
	return v.isSet
}

func (v *NullableClassLevelClassSpecificAnyOf9) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClassLevelClassSpecificAnyOf9(val *ClassLevelClassSpecificAnyOf9) *NullableClassLevelClassSpecificAnyOf9 {
	return &NullableClassLevelClassSpecificAnyOf9{value: val, isSet: true}
}

func (v NullableClassLevelClassSpecificAnyOf9) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClassLevelClassSpecificAnyOf9) UnmarshalJSON(src []byte) error {
	v.isSet = true
