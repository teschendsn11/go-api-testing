...
// OptionOneOf2 struct for OptionOneOf2
type OptionOneOf2 struct {
...
// SetItems gets a reference to the given []Option and assigns it to the Items field.
func (o *OptionOneOf2) SetItems(v []Option) {
	o.Items = v
}

func (o OptionOneOf2) MarshalJSON() ([]byte, error) {
...
type NullableOptionOneOf2 struct {
	value *OptionOneOf2
	isSet bool
}

func (v NullableOptionOneOf2) Get() *OptionOneOf2 {
	return v.value
}

func (v *NullableOptionOneOf2) Set(val *OptionOneOf2) {
	v.value = val
	v.isSet = true
}

func (v NullableOptionOneOf2) IsSet() bool {
	return v.isSet
}

func (v *NullableOptionOneOf2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptionOneOf2(val *OptionOneOf2) *NullableOptionOneOf2 {
	return &NullableOptionOneOf2{value: val, isSet: true}
}

func (v NullableOptionOneOf2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptionOneOf2) UnmarshalJSON(src []byte) error {
	v.isSet = true
