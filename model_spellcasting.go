...
type Spellcasting struct {
	...
	Info []SpellcastingInfoInner `json:"info,omitempty"`
	SpellcastingAbility *SpellcastingSpellcastingAbility `json:"spellcasting_ability,omitempty"`
}
...
// SetInfo gets a reference to the given []SpellcastingInfoInner and assigns it to the Info field.
func (o *Spellcasting) SetInfo(v []SpellcastingInfoInner) {
	o.Info = v
}

// GetSpellcastingAbility returns the SpellcastingAbility field value if set, zero value otherwise.
func (o *Spellcasting) GetSpellcastingAbility() SpellcastingSpellcastingAbility {
	if o == nil || isNil(o.SpellcastingAbility) {
		var ret SpellcastingSpellcastingAbility
		return ret
	}
	return *o.SpellcastingAbility
}

// GetSpellcastingAbilityOk returns a tuple with the SpellcastingAbility field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Spellcasting) GetSpellcastingAbilityOk() (*SpellcastingSpellcastingAbility, bool) {
	if o == nil || isNil(o.SpellcastingAbility) {
    return nil, false
	}
	return o.SpellcastingAbility, true
}
...
// SetSpellcastingAbility gets a reference to the given SpellcastingSpellcastingAbility and assigns it to the SpellcastingAbility field.
func (o *Spellcasting) SetSpellcastingAbility(v SpellcastingSpellcastingAbility) {
	o.SpellcastingAbility = &v
}

func (o Spellcasting) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.SpellcastingAbility) {
		toSerialize["spellcasting_ability"] = o.SpellcastingAbility
	}
	return json.Marshal(toSerialize)
}

type NullableSpellcasting struct {
	value *Spellcasting
	isSet bool
}

func (v NullableSpellcasting) Get() *Spellcasting {
	return v.value
}

func (v *NullableSpellcasting) Set(val *Spellcasting) {
	v.value = val
	v.isSet = true
}

func (v NullableSpellcasting) IsSet() bool {
	return v.isSet
}

func (v *NullableSpellcasting) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpellcasting(val *Spellcasting) *NullableSpellcasting {
	return &NullableSpellcasting{value: val, isSet: true}
}

func (v NullableSpellcasting) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpellcasting) UnmarshalJSON(src []byte) error {
	v.isSet = true
