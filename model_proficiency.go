...
func (o Proficiency) MarshalJSON() ([]byte, error) {
...
type NullableProficiency struct {
	value *Proficiency
	isSet bool
}

func (v NullableProficiency) Get() *Proficiency {
	return v.value
}

func (v *NullableProficiency) Set(val *Proficiency) {
	v.value = val
	v.isSet = true
}

func (v NullableProficiency) IsSet() bool {
	return v.isSet
}

func (v *NullableProficiency) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProficiency(val *Proficiency) *NullableProficiency {
	return &NullableProficiency{value: val, isSet: true}
}

func (v NullableProficiency) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProficiency) UnmarshalJSON(src []byte) error {
	v.isSet = true
