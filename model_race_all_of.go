...
// RaceAllOf struct for RaceAllOf
type RaceAllOf struct {
...
func (o RaceAllOf) MarshalJSON() ([]byte, error) {
...
type NullableRaceAllOf struct {
	value *RaceAllOf
	isSet bool
}

func (v NullableRaceAllOf) Get() *RaceAllOf {
	return v.value
}

func (v *NullableRaceAllOf) Set(val *RaceAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableRaceAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableRaceAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRaceAllOf(val *RaceAllOf) *NullableRaceAllOf {
	return &NullableRaceAllOf{value: val, isSet: true}
}

func (v NullableRaceAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRaceAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
