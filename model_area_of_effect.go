...
// AreaOfEffect struct for AreaOfEffect
...
func (o AreaOfEffect) MarshalJSON() ([]byte, error) {
...
type NullableAreaOfEffect struct {
	value *AreaOfEffect
	isSet bool
}

func (v NullableAreaOfEffect) Get() *AreaOfEffect {
	return v.value
}

func (v *NullableAreaOfEffect) Set(val *AreaOfEffect) {
	v.value = val
	v.isSet = true
}

func (v NullableAreaOfEffect) IsSet() bool {
	return v.isSet
}

func (v *NullableAreaOfEffect) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAreaOfEffect(val *AreaOfEffect) *NullableAreaOfEffect {
	return &NullableAreaOfEffect{value: val, isSet: true}
}

func (v NullableAreaOfEffect) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAreaOfEffect) UnmarshalJSON(src []byte) error {
	v.isSet = true
