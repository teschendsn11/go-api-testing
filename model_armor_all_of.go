...
// ArmorAllOf struct for ArmorAllOf
type ArmorAllOf struct {
...
func (o ArmorAllOf) MarshalJSON() ([]byte, error) {
...
type NullableArmorAllOf struct {
	value *ArmorAllOf
	isSet bool
}

func (v NullableArmorAllOf) Get() *ArmorAllOf {
	return v.value
}

func (v *NullableArmorAllOf) Set(val *ArmorAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableArmorAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableArmorAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArmorAllOf(val *ArmorAllOf) *NullableArmorAllOf {
	return &NullableArmorAllOf{value: val, isSet: true}
}

func (v NullableArmorAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArmorAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
