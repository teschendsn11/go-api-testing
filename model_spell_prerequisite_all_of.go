...
// SpellPrerequisiteAllOf struct for SpellPrerequisiteAllOf
type SpellPrerequisiteAllOf struct {
...
func (o SpellPrerequisiteAllOf) MarshalJSON() ([]byte, error) {
...
type NullableSpellPrerequisiteAllOf struct {
	value *SpellPrerequisiteAllOf
	isSet bool
}

func (v NullableSpellPrerequisiteAllOf) Get() *SpellPrerequisiteAllOf {
	return v.value
}

func (v *NullableSpellPrerequisiteAllOf) Set(val *SpellPrerequisiteAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSpellPrerequisiteAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSpellPrerequisiteAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpellPrerequisiteAllOf(val *SpellPrerequisiteAllOf) *NullableSpellPrerequisiteAllOf {
	return &NullableSpellPrerequisiteAllOf{value: val, isSet: true}
}

func (v NullableSpellPrerequisiteAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpellPrerequisiteAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
