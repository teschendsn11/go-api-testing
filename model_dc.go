...
// SetDcType gets a reference to the given APIReference and assigns it to the DcType field.
func (o *DC) SetDcType(v APIReference) {
	o.DcType = &v
}

// GetDcValue returns the DcValue field value if set, zero value otherwise.
func (o *DC) GetDcValue() float32 {
	if o == nil || isNil(o.DcValue) {
		var ret float32
		return ret
	}
	return *o.DcValue
...
// GetDcValueOk returns a tuple with the DcValue field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DC) GetDcValueOk() (*float32, bool) {
	if o == nil || isNil(o.DcValue) {
    return nil, false
	}
	return o.DcValue, true
}
...
// SetDcValue gets a reference to the given float32 and assigns it to the DcValue field.
...
// SetSuccessType gets a reference to the given string and assigns it to the SuccessType field.
func (o *DC) SetSuccessType(v string) {
	o.SuccessType = &v
}

func (o DC) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.DcType) {
		toSerialize["dc_type"] = o.DcType
	}
	if !isNil(o.DcValue) {
		toSerialize["dc_value"] = o.DcValue
	}
	if !isNil(o.SuccessType) {
		toSerialize["success_type"] = o.SuccessType
	}
	return json.Marshal(toSerialize)
}

type NullableDC struct {
	value *DC
	isSet bool
}

func (v NullableDC) Get() *DC {
	return v.value
}

func (v *NullableDC) Set(val *DC) {
	v.value = val
	v.isSet = true
}

func (v NullableDC) IsSet() bool {
	return v.isSet
}

func (v *NullableDC) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDC(val *DC) *NullableDC {
	return &NullableDC{value: val, isSet: true}
}

func (v NullableDC) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDC) UnmarshalJSON(src []byte) error {
	v.isSet = true
