...
// MonsterAllOf1Proficiencies struct for MonsterAllOf1Proficiencies
type MonsterAllOf1Proficiencies struct {
...
func NewMonsterAllOf1Proficiencies() *MonsterAllOf1Proficiencies {
	this := MonsterAllOf1Proficiencies{}
	return &this
}
...
// SetProficiency gets a reference to the given APIReference and assigns it to the Proficiency field.
func (o *MonsterAllOf1Proficiencies) SetProficiency(v APIReference) {
	o.Proficiency = &v
}

func (o MonsterAllOf1Proficiencies) MarshalJSON() ([]byte, error) {
...
type NullableMonsterAllOf1Proficiencies struct {
	value *MonsterAllOf1Proficiencies
	isSet bool
}

func (v NullableMonsterAllOf1Proficiencies) Get() *MonsterAllOf1Proficiencies {
	return v.value
}

func (v *NullableMonsterAllOf1Proficiencies) Set(val *MonsterAllOf1Proficiencies) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterAllOf1Proficiencies) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterAllOf1Proficiencies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterAllOf1Proficiencies(val *MonsterAllOf1Proficiencies) *NullableMonsterAllOf1Proficiencies {
	return &NullableMonsterAllOf1Proficiencies{value: val, isSet: true}
}

func (v NullableMonsterAllOf1Proficiencies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterAllOf1Proficiencies) UnmarshalJSON(src []byte) error {
	v.isSet = true
