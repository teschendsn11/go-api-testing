...
type Feature struct {
	...
	Prerequisites []AnyOfobjectobjectobject `json:"prerequisites,omitempty"`
...
// SetPrerequisites gets a reference to the given []AnyOfobjectobjectobject and assigns it to the Prerequisites field.
