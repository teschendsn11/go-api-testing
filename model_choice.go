...
// GetChoose returns the Choose field value if set, zero value otherwise.
func (o *Choice) GetChoose() float32 {
	if o == nil || isNil(o.Choose) {
		var ret float32
		return ret
	}
	return *o.Choose
...
// GetChooseOk returns a tuple with the Choose field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Choice) GetChooseOk() (*float32, bool) {
	if o == nil || isNil(o.Choose) {
    return nil, false
	}
	return o.Choose, true
}
...
// SetChoose gets a reference to the given float32 and assigns it to the Choose field.
...
// SetFrom gets a reference to the given OptionSet and assigns it to the From field.
