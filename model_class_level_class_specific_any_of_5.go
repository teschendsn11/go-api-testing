...
// ClassLevelClassSpecificAnyOf5 Monk Class Specific Features
type ClassLevelClassSpecificAnyOf5 struct {
	KiPoints *float32 `json:"ki_points,omitempty"`
	UnarmoredMovement *float32 `json:"unarmored_movement,omitempty"`
	MartialArts *ClassLevelClassSpecificAnyOf5MartialArts `json:"martial_arts,omitempty"`
}
...
func NewClassLevelClassSpecificAnyOf5() *ClassLevelClassSpecificAnyOf5 {
	this := ClassLevelClassSpecificAnyOf5{}
	return &this
}
...
// GetKiPoints returns the KiPoints field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf5) GetKiPoints() float32 {
	if o == nil || isNil(o.KiPoints) {
		var ret float32
		return ret
	}
	return *o.KiPoints
...
// GetKiPointsOk returns a tuple with the KiPoints field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf5) GetKiPointsOk() (*float32, bool) {
	if o == nil || isNil(o.KiPoints) {
    return nil, false
	}
	return o.KiPoints, true
}
...
// SetKiPoints gets a reference to the given float32 and assigns it to the KiPoints field.
func (o *ClassLevelClassSpecificAnyOf5) SetKiPoints(v float32) {
	o.KiPoints = &v
}

// GetUnarmoredMovement returns the UnarmoredMovement field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf5) GetUnarmoredMovement() float32 {
	if o == nil || isNil(o.UnarmoredMovement) {
		var ret float32
		return ret
	}
	return *o.UnarmoredMovement
}

// GetUnarmoredMovementOk returns a tuple with the UnarmoredMovement field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf5) GetUnarmoredMovementOk() (*float32, bool) {
	if o == nil || isNil(o.UnarmoredMovement) {
    return nil, false
	}
	return o.UnarmoredMovement, true
}
...
// SetUnarmoredMovement gets a reference to the given float32 and assigns it to the UnarmoredMovement field.
func (o *ClassLevelClassSpecificAnyOf5) SetUnarmoredMovement(v float32) {
	o.UnarmoredMovement = &v
}

// GetMartialArts returns the MartialArts field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf5) GetMartialArts() ClassLevelClassSpecificAnyOf5MartialArts {
	if o == nil || isNil(o.MartialArts) {
		var ret ClassLevelClassSpecificAnyOf5MartialArts
		return ret
	}
	return *o.MartialArts
}

// GetMartialArtsOk returns a tuple with the MartialArts field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf5) GetMartialArtsOk() (*ClassLevelClassSpecificAnyOf5MartialArts, bool) {
	if o == nil || isNil(o.MartialArts) {
    return nil, false
	}
	return o.MartialArts, true
}
...
// SetMartialArts gets a reference to the given ClassLevelClassSpecificAnyOf5MartialArts and assigns it to the MartialArts field.
func (o *ClassLevelClassSpecificAnyOf5) SetMartialArts(v ClassLevelClassSpecificAnyOf5MartialArts) {
	o.MartialArts = &v
}

func (o ClassLevelClassSpecificAnyOf5) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.KiPoints) {
		toSerialize["ki_points"] = o.KiPoints
	}
	if !isNil(o.UnarmoredMovement) {
		toSerialize["unarmored_movement"] = o.UnarmoredMovement
	}
	if !isNil(o.MartialArts) {
		toSerialize["martial_arts"] = o.MartialArts
	}
	return json.Marshal(toSerialize)
}

type NullableClassLevelClassSpecificAnyOf5 struct {
	value *ClassLevelClassSpecificAnyOf5
	isSet bool
}

func (v NullableClassLevelClassSpecificAnyOf5) Get() *ClassLevelClassSpecificAnyOf5 {
	return v.value
}

func (v *NullableClassLevelClassSpecificAnyOf5) Set(val *ClassLevelClassSpecificAnyOf5) {
	v.value = val
	v.isSet = true
}

func (v NullableClassLevelClassSpecificAnyOf5) IsSet() bool {
	return v.isSet
}

func (v *NullableClassLevelClassSpecificAnyOf5) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClassLevelClassSpecificAnyOf5(val *ClassLevelClassSpecificAnyOf5) *NullableClassLevelClassSpecificAnyOf5 {
	return &NullableClassLevelClassSpecificAnyOf5{value: val, isSet: true}
}

func (v NullableClassLevelClassSpecificAnyOf5) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClassLevelClassSpecificAnyOf5) UnmarshalJSON(src []byte) error {
	v.isSet = true
