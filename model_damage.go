...
func (o Damage) MarshalJSON() ([]byte, error) {
...
type NullableDamage struct {
	value *Damage
	isSet bool
}

func (v NullableDamage) Get() *Damage {
	return v.value
}

func (v *NullableDamage) Set(val *Damage) {
	v.value = val
	v.isSet = true
}

func (v NullableDamage) IsSet() bool {
	return v.isSet
}

func (v *NullableDamage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDamage(val *Damage) *NullableDamage {
	return &NullableDamage{value: val, isSet: true}
}

func (v NullableDamage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDamage) UnmarshalJSON(src []byte) error {
	v.isSet = true
