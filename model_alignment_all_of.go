...
// AlignmentAllOf struct for AlignmentAllOf
type AlignmentAllOf struct {
...
func (o AlignmentAllOf) MarshalJSON() ([]byte, error) {
...
type NullableAlignmentAllOf struct {
	value *AlignmentAllOf
	isSet bool
}

func (v NullableAlignmentAllOf) Get() *AlignmentAllOf {
	return v.value
}

func (v *NullableAlignmentAllOf) Set(val *AlignmentAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableAlignmentAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableAlignmentAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlignmentAllOf(val *AlignmentAllOf) *NullableAlignmentAllOf {
	return &NullableAlignmentAllOf{value: val, isSet: true}
}

func (v NullableAlignmentAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlignmentAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
