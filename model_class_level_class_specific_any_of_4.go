...
// ClassLevelClassSpecificAnyOf4 Fighter Class Specific Features
type ClassLevelClassSpecificAnyOf4 struct {
...
func NewClassLevelClassSpecificAnyOf4() *ClassLevelClassSpecificAnyOf4 {
	this := ClassLevelClassSpecificAnyOf4{}
	return &this
}
...
// GetActionSurges returns the ActionSurges field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf4) GetActionSurges() float32 {
	if o == nil || isNil(o.ActionSurges) {
		var ret float32
		return ret
	}
	return *o.ActionSurges
}

// GetActionSurgesOk returns a tuple with the ActionSurges field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf4) GetActionSurgesOk() (*float32, bool) {
	if o == nil || isNil(o.ActionSurges) {
    return nil, false
	}
	return o.ActionSurges, true
}
...
// SetActionSurges gets a reference to the given float32 and assigns it to the ActionSurges field.
func (o *ClassLevelClassSpecificAnyOf4) SetActionSurges(v float32) {
	o.ActionSurges = &v
}

// GetIndomitableUses returns the IndomitableUses field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf4) GetIndomitableUses() float32 {
	if o == nil || isNil(o.IndomitableUses) {
		var ret float32
		return ret
	}
	return *o.IndomitableUses
}

// GetIndomitableUsesOk returns a tuple with the IndomitableUses field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf4) GetIndomitableUsesOk() (*float32, bool) {
	if o == nil || isNil(o.IndomitableUses) {
    return nil, false
	}
	return o.IndomitableUses, true
}
...
// SetIndomitableUses gets a reference to the given float32 and assigns it to the IndomitableUses field.
func (o *ClassLevelClassSpecificAnyOf4) SetIndomitableUses(v float32) {
	o.IndomitableUses = &v
}

// GetExtraAttacks returns the ExtraAttacks field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf4) GetExtraAttacks() float32 {
	if o == nil || isNil(o.ExtraAttacks) {
		var ret float32
		return ret
	}
	return *o.ExtraAttacks
}

// GetExtraAttacksOk returns a tuple with the ExtraAttacks field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf4) GetExtraAttacksOk() (*float32, bool) {
	if o == nil || isNil(o.ExtraAttacks) {
    return nil, false
	}
	return o.ExtraAttacks, true
}
...
// SetExtraAttacks gets a reference to the given float32 and assigns it to the ExtraAttacks field.
func (o *ClassLevelClassSpecificAnyOf4) SetExtraAttacks(v float32) {
	o.ExtraAttacks = &v
}

func (o ClassLevelClassSpecificAnyOf4) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.ActionSurges) {
		toSerialize["action_surges"] = o.ActionSurges
	}
	if !isNil(o.IndomitableUses) {
		toSerialize["indomitable_uses"] = o.IndomitableUses
	}
	if !isNil(o.ExtraAttacks) {
		toSerialize["extra_attacks"] = o.ExtraAttacks
	}
	return json.Marshal(toSerialize)
}

type NullableClassLevelClassSpecificAnyOf4 struct {
	value *ClassLevelClassSpecificAnyOf4
	isSet bool
}

func (v NullableClassLevelClassSpecificAnyOf4) Get() *ClassLevelClassSpecificAnyOf4 {
	return v.value
}

func (v *NullableClassLevelClassSpecificAnyOf4) Set(val *ClassLevelClassSpecificAnyOf4) {
	v.value = val
	v.isSet = true
}

func (v NullableClassLevelClassSpecificAnyOf4) IsSet() bool {
	return v.isSet
}

func (v *NullableClassLevelClassSpecificAnyOf4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClassLevelClassSpecificAnyOf4(val *ClassLevelClassSpecificAnyOf4) *NullableClassLevelClassSpecificAnyOf4 {
	return &NullableClassLevelClassSpecificAnyOf4{value: val, isSet: true}
}

func (v NullableClassLevelClassSpecificAnyOf4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClassLevelClassSpecificAnyOf4) UnmarshalJSON(src []byte) error {
	v.isSet = true
