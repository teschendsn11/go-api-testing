...
// OptionOneOf7 struct for OptionOneOf7
type OptionOneOf7 struct {
...
// GetAbilityScore returns the AbilityScore field value if set, zero value otherwise.
func (o *OptionOneOf7) GetAbilityScore() APIReference {
	if o == nil || isNil(o.AbilityScore) {
		var ret APIReference
		return ret
	}
	return *o.AbilityScore
}

// GetAbilityScoreOk returns a tuple with the AbilityScore field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OptionOneOf7) GetAbilityScoreOk() (*APIReference, bool) {
	if o == nil || isNil(o.AbilityScore) {
    return nil, false
	}
	return o.AbilityScore, true
}
...
// SetAbilityScore gets a reference to the given APIReference and assigns it to the AbilityScore field.
...
// SetMinimumScore gets a reference to the given float32 and assigns it to the MinimumScore field.
func (o *OptionOneOf7) SetMinimumScore(v float32) {
	o.MinimumScore = &v
}

func (o OptionOneOf7) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.OptionType) {
		toSerialize["option_type"] = o.OptionType
	}
	if !isNil(o.AbilityScore) {
		toSerialize["ability_score"] = o.AbilityScore
	}
...
type NullableOptionOneOf7 struct {
	value *OptionOneOf7
	isSet bool
}

func (v NullableOptionOneOf7) Get() *OptionOneOf7 {
	return v.value
}

func (v *NullableOptionOneOf7) Set(val *OptionOneOf7) {
	v.value = val
	v.isSet = true
}

func (v NullableOptionOneOf7) IsSet() bool {
	return v.isSet
}

func (v *NullableOptionOneOf7) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptionOneOf7(val *OptionOneOf7) *NullableOptionOneOf7 {
	return &NullableOptionOneOf7{value: val, isSet: true}
}

func (v NullableOptionOneOf7) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptionOneOf7) UnmarshalJSON(src []byte) error {
	v.isSet = true
