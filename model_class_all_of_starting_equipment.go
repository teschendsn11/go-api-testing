...
// ClassAllOfStartingEquipment struct for ClassAllOfStartingEquipment
type ClassAllOfStartingEquipment struct {
...
func NewClassAllOfStartingEquipment() *ClassAllOfStartingEquipment {
	this := ClassAllOfStartingEquipment{}
	return &this
}
...
// SetEquipment gets a reference to the given APIReference and assigns it to the Equipment field.
func (o *ClassAllOfStartingEquipment) SetEquipment(v APIReference) {
	o.Equipment = &v
}

func (o ClassAllOfStartingEquipment) MarshalJSON() ([]byte, error) {
...
type NullableClassAllOfStartingEquipment struct {
	value *ClassAllOfStartingEquipment
	isSet bool
}

func (v NullableClassAllOfStartingEquipment) Get() *ClassAllOfStartingEquipment {
	return v.value
}

func (v *NullableClassAllOfStartingEquipment) Set(val *ClassAllOfStartingEquipment) {
	v.value = val
	v.isSet = true
}

func (v NullableClassAllOfStartingEquipment) IsSet() bool {
	return v.isSet
}

func (v *NullableClassAllOfStartingEquipment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClassAllOfStartingEquipment(val *ClassAllOfStartingEquipment) *NullableClassAllOfStartingEquipment {
	return &NullableClassAllOfStartingEquipment{value: val, isSet: true}
}

func (v NullableClassAllOfStartingEquipment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClassAllOfStartingEquipment) UnmarshalJSON(src []byte) error {
	v.isSet = true
