...
// OptionOneOf5 struct for OptionOneOf5
type OptionOneOf5 struct {
...
// SetAlignments gets a reference to the given []APIReference and assigns it to the Alignments field.
func (o *OptionOneOf5) SetAlignments(v []APIReference) {
	o.Alignments = v
}

func (o OptionOneOf5) MarshalJSON() ([]byte, error) {
...
type NullableOptionOneOf5 struct {
	value *OptionOneOf5
	isSet bool
}

func (v NullableOptionOneOf5) Get() *OptionOneOf5 {
	return v.value
}

func (v *NullableOptionOneOf5) Set(val *OptionOneOf5) {
	v.value = val
	v.isSet = true
}

func (v NullableOptionOneOf5) IsSet() bool {
	return v.isSet
}

func (v *NullableOptionOneOf5) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptionOneOf5(val *OptionOneOf5) *NullableOptionOneOf5 {
	return &NullableOptionOneOf5{value: val, isSet: true}
}

func (v NullableOptionOneOf5) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptionOneOf5) UnmarshalJSON(src []byte) error {
	v.isSet = true
