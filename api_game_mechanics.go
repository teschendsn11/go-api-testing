...
// GameMechanicsApiService GameMechanicsApi service
type GameMechanicsApiService service

type ApiApiConditionsIndexGetRequest struct {
	ctx context.Context
	ApiService *GameMechanicsApiService
	index string
}

func (r ApiApiConditionsIndexGetRequest) Execute() (*Condition, *http.Response, error) {
	return r.ApiService.ApiConditionsIndexGetExecute(r)
}

/*
ApiConditionsIndexGet Get a condition by index.
...
as invisible, can be advantageous.
 ...
 @return ApiApiConditionsIndexGetRequest
*/
func (a *GameMechanicsApiService) ApiConditionsIndexGet(ctx context.Context, index string) ApiApiConditionsIndexGetRequest {
	return ApiApiConditionsIndexGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
//  @return Condition
func (a *GameMechanicsApiService) ApiConditionsIndexGetExecute(r ApiApiConditionsIndexGetRequest) (*Condition, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GameMechanicsApiService.ApiConditionsIndexGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/conditions/{index}"
...
type ApiApiDamageTypesIndexGetRequest struct {
	ctx context.Context
	ApiService *GameMechanicsApiService
	index string
}

func (r ApiApiDamageTypesIndexGetRequest) Execute() (*DamageType, *http.Response, error) {
	return r.ApiService.ApiDamageTypesIndexGetExecute(r)
}

/*
ApiDamageTypesIndexGet Get a damage type by index.
...
such as damage resistance, rely on the types.
 ...
 @return ApiApiDamageTypesIndexGetRequest
*/
func (a *GameMechanicsApiService) ApiDamageTypesIndexGet(ctx context.Context, index string) ApiApiDamageTypesIndexGetRequest {
	return ApiApiDamageTypesIndexGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
// Execute executes the request
//  @return DamageType
func (a *GameMechanicsApiService) ApiDamageTypesIndexGetExecute(r ApiApiDamageTypesIndexGetRequest) (*DamageType, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DamageType
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GameMechanicsApiService.ApiDamageTypesIndexGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/damage-types/{index}"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
...
type ApiApiMagicSchoolsIndexGetRequest struct {
	ctx context.Context
	ApiService *GameMechanicsApiService
	index string
}

func (r ApiApiMagicSchoolsIndexGetRequest) Execute() (*MagicSchool, *http.Response, error) {
	return r.ApiService.ApiMagicSchoolsIndexGetExecute(r)
}

/*
ApiMagicSchoolsIndexGet Get a magic school by index.
...
derives from rigorous study or is bestowed by a deity.
 ...
 @return ApiApiMagicSchoolsIndexGetRequest
*/
func (a *GameMechanicsApiService) ApiMagicSchoolsIndexGet(ctx context.Context, index string) ApiApiMagicSchoolsIndexGetRequest {
	return ApiApiMagicSchoolsIndexGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
// Execute executes the request
//  @return MagicSchool
func (a *GameMechanicsApiService) ApiMagicSchoolsIndexGetExecute(r ApiApiMagicSchoolsIndexGetRequest) (*MagicSchool, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MagicSchool
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GameMechanicsApiService.ApiMagicSchoolsIndexGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/magic-schools/{index}"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
