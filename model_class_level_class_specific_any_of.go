...
// ClassLevelClassSpecificAnyOf Barbarian Class Specific Features
type ClassLevelClassSpecificAnyOf struct {
...
func NewClassLevelClassSpecificAnyOf() *ClassLevelClassSpecificAnyOf {
	this := ClassLevelClassSpecificAnyOf{}
	return &this
}
...
// GetRageCount returns the RageCount field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf) GetRageCount() float32 {
	if o == nil || isNil(o.RageCount) {
		var ret float32
		return ret
	}
	return *o.RageCount
...
// GetRageCountOk returns a tuple with the RageCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf) GetRageCountOk() (*float32, bool) {
	if o == nil || isNil(o.RageCount) {
    return nil, false
	}
	return o.RageCount, true
}
...
// SetRageCount gets a reference to the given float32 and assigns it to the RageCount field.
func (o *ClassLevelClassSpecificAnyOf) SetRageCount(v float32) {
	o.RageCount = &v
}

// GetRageDamageBonus returns the RageDamageBonus field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf) GetRageDamageBonus() float32 {
	if o == nil || isNil(o.RageDamageBonus) {
		var ret float32
		return ret
	}
	return *o.RageDamageBonus
}

// GetRageDamageBonusOk returns a tuple with the RageDamageBonus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf) GetRageDamageBonusOk() (*float32, bool) {
	if o == nil || isNil(o.RageDamageBonus) {
    return nil, false
	}
	return o.RageDamageBonus, true
}
...
// SetRageDamageBonus gets a reference to the given float32 and assigns it to the RageDamageBonus field.
func (o *ClassLevelClassSpecificAnyOf) SetRageDamageBonus(v float32) {
	o.RageDamageBonus = &v
}

// GetBrutalCriticalDice returns the BrutalCriticalDice field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf) GetBrutalCriticalDice() float32 {
	if o == nil || isNil(o.BrutalCriticalDice) {
		var ret float32
		return ret
	}
	return *o.BrutalCriticalDice
}

// GetBrutalCriticalDiceOk returns a tuple with the BrutalCriticalDice field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf) GetBrutalCriticalDiceOk() (*float32, bool) {
	if o == nil || isNil(o.BrutalCriticalDice) {
    return nil, false
	}
	return o.BrutalCriticalDice, true
}
...
// SetBrutalCriticalDice gets a reference to the given float32 and assigns it to the BrutalCriticalDice field.
func (o *ClassLevelClassSpecificAnyOf) SetBrutalCriticalDice(v float32) {
	o.BrutalCriticalDice = &v
}

func (o ClassLevelClassSpecificAnyOf) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.RageCount) {
		toSerialize["rage_count"] = o.RageCount
	}
	if !isNil(o.RageDamageBonus) {
		toSerialize["rage_damage_bonus"] = o.RageDamageBonus
	}
	if !isNil(o.BrutalCriticalDice) {
		toSerialize["brutal_critical_dice"] = o.BrutalCriticalDice
	}
	return json.Marshal(toSerialize)
}

type NullableClassLevelClassSpecificAnyOf struct {
	value *ClassLevelClassSpecificAnyOf
	isSet bool
}

func (v NullableClassLevelClassSpecificAnyOf) Get() *ClassLevelClassSpecificAnyOf {
	return v.value
}

func (v *NullableClassLevelClassSpecificAnyOf) Set(val *ClassLevelClassSpecificAnyOf) {
	v.value = val
	v.isSet = true
}

func (v NullableClassLevelClassSpecificAnyOf) IsSet() bool {
	return v.isSet
}

func (v *NullableClassLevelClassSpecificAnyOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClassLevelClassSpecificAnyOf(val *ClassLevelClassSpecificAnyOf) *NullableClassLevelClassSpecificAnyOf {
	return &NullableClassLevelClassSpecificAnyOf{value: val, isSet: true}
}

func (v NullableClassLevelClassSpecificAnyOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClassLevelClassSpecificAnyOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
