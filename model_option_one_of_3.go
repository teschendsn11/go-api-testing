...
// OptionOneOf3 struct for OptionOneOf3
type OptionOneOf3 struct {
...
// SetChoice gets a reference to the given Choice and assigns it to the Choice field.
func (o *OptionOneOf3) SetChoice(v Choice) {
	o.Choice = &v
}

func (o OptionOneOf3) MarshalJSON() ([]byte, error) {
...
type NullableOptionOneOf3 struct {
	value *OptionOneOf3
	isSet bool
}

func (v NullableOptionOneOf3) Get() *OptionOneOf3 {
	return v.value
}

func (v *NullableOptionOneOf3) Set(val *OptionOneOf3) {
	v.value = val
	v.isSet = true
}

func (v NullableOptionOneOf3) IsSet() bool {
	return v.isSet
}

func (v *NullableOptionOneOf3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptionOneOf3(val *OptionOneOf3) *NullableOptionOneOf3 {
	return &NullableOptionOneOf3{value: val, isSet: true}
}

func (v NullableOptionOneOf3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptionOneOf3) UnmarshalJSON(src []byte) error {
	v.isSet = true
