...
type Prerequisite struct {
	AbilityScore *PrerequisiteAbilityScore `json:"ability_score,omitempty"`
...
func (o *Prerequisite) GetAbilityScore() PrerequisiteAbilityScore {
	if o == nil || isNil(o.AbilityScore) {
		var ret PrerequisiteAbilityScore
		return ret
	}
...
// SetAbilityScore gets a reference to the given PrerequisiteAbilityScore and assigns it to the AbilityScore field.
...
func NewNullablePrerequisite(val *Prerequisite) *NullablePrerequisite {
	return &NullablePrerequisite{value: val, isSet: true}
}
