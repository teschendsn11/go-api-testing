...
// ClassLevelClassSpecificAnyOf5MartialArts struct for ClassLevelClassSpecificAnyOf5MartialArts
type ClassLevelClassSpecificAnyOf5MartialArts struct {
...
func NewClassLevelClassSpecificAnyOf5MartialArts() *ClassLevelClassSpecificAnyOf5MartialArts {
	this := ClassLevelClassSpecificAnyOf5MartialArts{}
	return &this
}
...
// GetDiceCount returns the DiceCount field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf5MartialArts) GetDiceCount() float32 {
	if o == nil || isNil(o.DiceCount) {
		var ret float32
		return ret
	}
	return *o.DiceCount
...
// GetDiceCountOk returns a tuple with the DiceCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf5MartialArts) GetDiceCountOk() (*float32, bool) {
	if o == nil || isNil(o.DiceCount) {
    return nil, false
	}
	return o.DiceCount, true
}
...
// SetDiceCount gets a reference to the given float32 and assigns it to the DiceCount field.
func (o *ClassLevelClassSpecificAnyOf5MartialArts) SetDiceCount(v float32) {
	o.DiceCount = &v
}

// GetDiceValue returns the DiceValue field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf5MartialArts) GetDiceValue() float32 {
	if o == nil || isNil(o.DiceValue) {
		var ret float32
		return ret
	}
	return *o.DiceValue
...
// GetDiceValueOk returns a tuple with the DiceValue field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf5MartialArts) GetDiceValueOk() (*float32, bool) {
	if o == nil || isNil(o.DiceValue) {
    return nil, false
	}
	return o.DiceValue, true
}
...
// SetDiceValue gets a reference to the given float32 and assigns it to the DiceValue field.
func (o *ClassLevelClassSpecificAnyOf5MartialArts) SetDiceValue(v float32) {
	o.DiceValue = &v
}

func (o ClassLevelClassSpecificAnyOf5MartialArts) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.DiceCount) {
		toSerialize["dice_count"] = o.DiceCount
	}
	if !isNil(o.DiceValue) {
		toSerialize["dice_value"] = o.DiceValue
	}
	return json.Marshal(toSerialize)
}

type NullableClassLevelClassSpecificAnyOf5MartialArts struct {
	value *ClassLevelClassSpecificAnyOf5MartialArts
	isSet bool
}

func (v NullableClassLevelClassSpecificAnyOf5MartialArts) Get() *ClassLevelClassSpecificAnyOf5MartialArts {
	return v.value
}

func (v *NullableClassLevelClassSpecificAnyOf5MartialArts) Set(val *ClassLevelClassSpecificAnyOf5MartialArts) {
	v.value = val
	v.isSet = true
}

func (v NullableClassLevelClassSpecificAnyOf5MartialArts) IsSet() bool {
	return v.isSet
}

func (v *NullableClassLevelClassSpecificAnyOf5MartialArts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClassLevelClassSpecificAnyOf5MartialArts(val *ClassLevelClassSpecificAnyOf5MartialArts) *NullableClassLevelClassSpecificAnyOf5MartialArts {
	return &NullableClassLevelClassSpecificAnyOf5MartialArts{value: val, isSet: true}
}

func (v NullableClassLevelClassSpecificAnyOf5MartialArts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClassLevelClassSpecificAnyOf5MartialArts) UnmarshalJSON(src []byte) error {
	v.isSet = true
