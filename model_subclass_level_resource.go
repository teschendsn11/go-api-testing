...
// SubclassLevelResource struct for SubclassLevelResource
...
func (o SubclassLevelResource) MarshalJSON() ([]byte, error) {
...
type NullableSubclassLevelResource struct {
	value *SubclassLevelResource
	isSet bool
}

func (v NullableSubclassLevelResource) Get() *SubclassLevelResource {
	return v.value
}

func (v *NullableSubclassLevelResource) Set(val *SubclassLevelResource) {
	v.value = val
	v.isSet = true
}

func (v NullableSubclassLevelResource) IsSet() bool {
	return v.isSet
}

func (v *NullableSubclassLevelResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubclassLevelResource(val *SubclassLevelResource) *NullableSubclassLevelResource {
	return &NullableSubclassLevelResource{value: val, isSet: true}
}

func (v NullableSubclassLevelResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubclassLevelResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
