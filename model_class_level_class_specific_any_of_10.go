...
// ClassLevelClassSpecificAnyOf10 Bard Warlock Specific Features
type ClassLevelClassSpecificAnyOf10 struct {
...
func NewClassLevelClassSpecificAnyOf10() *ClassLevelClassSpecificAnyOf10 {
	this := ClassLevelClassSpecificAnyOf10{}
	return &this
}
...
// GetInvocationsKnown returns the InvocationsKnown field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf10) GetInvocationsKnown() float32 {
	if o == nil || isNil(o.InvocationsKnown) {
		var ret float32
		return ret
	}
	return *o.InvocationsKnown
}

// GetInvocationsKnownOk returns a tuple with the InvocationsKnown field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf10) GetInvocationsKnownOk() (*float32, bool) {
	if o == nil || isNil(o.InvocationsKnown) {
    return nil, false
	}
	return o.InvocationsKnown, true
}
...
// SetInvocationsKnown gets a reference to the given float32 and assigns it to the InvocationsKnown field.
func (o *ClassLevelClassSpecificAnyOf10) SetInvocationsKnown(v float32) {
	o.InvocationsKnown = &v
}

// GetMysticArcanumLevel6 returns the MysticArcanumLevel6 field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf10) GetMysticArcanumLevel6() float32 {
	if o == nil || isNil(o.MysticArcanumLevel6) {
		var ret float32
		return ret
	}
	return *o.MysticArcanumLevel6
}

// GetMysticArcanumLevel6Ok returns a tuple with the MysticArcanumLevel6 field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf10) GetMysticArcanumLevel6Ok() (*float32, bool) {
	if o == nil || isNil(o.MysticArcanumLevel6) {
    return nil, false
	}
	return o.MysticArcanumLevel6, true
}
...
// SetMysticArcanumLevel6 gets a reference to the given float32 and assigns it to the MysticArcanumLevel6 field.
func (o *ClassLevelClassSpecificAnyOf10) SetMysticArcanumLevel6(v float32) {
	o.MysticArcanumLevel6 = &v
}

// GetMysticArcanumLevel7 returns the MysticArcanumLevel7 field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf10) GetMysticArcanumLevel7() float32 {
	if o == nil || isNil(o.MysticArcanumLevel7) {
		var ret float32
		return ret
	}
	return *o.MysticArcanumLevel7
}

// GetMysticArcanumLevel7Ok returns a tuple with the MysticArcanumLevel7 field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf10) GetMysticArcanumLevel7Ok() (*float32, bool) {
	if o == nil || isNil(o.MysticArcanumLevel7) {
    return nil, false
	}
	return o.MysticArcanumLevel7, true
}
...
// SetMysticArcanumLevel7 gets a reference to the given float32 and assigns it to the MysticArcanumLevel7 field.
func (o *ClassLevelClassSpecificAnyOf10) SetMysticArcanumLevel7(v float32) {
	o.MysticArcanumLevel7 = &v
}

// GetMysticArcanumLevel8 returns the MysticArcanumLevel8 field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf10) GetMysticArcanumLevel8() float32 {
	if o == nil || isNil(o.MysticArcanumLevel8) {
		var ret float32
		return ret
	}
	return *o.MysticArcanumLevel8
}

// GetMysticArcanumLevel8Ok returns a tuple with the MysticArcanumLevel8 field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf10) GetMysticArcanumLevel8Ok() (*float32, bool) {
	if o == nil || isNil(o.MysticArcanumLevel8) {
    return nil, false
	}
	return o.MysticArcanumLevel8, true
}
...
// SetMysticArcanumLevel8 gets a reference to the given float32 and assigns it to the MysticArcanumLevel8 field.
func (o *ClassLevelClassSpecificAnyOf10) SetMysticArcanumLevel8(v float32) {
	o.MysticArcanumLevel8 = &v
}

// GetMysticArcanumLevel9 returns the MysticArcanumLevel9 field value if set, zero value otherwise.
func (o *ClassLevelClassSpecificAnyOf10) GetMysticArcanumLevel9() float32 {
	if o == nil || isNil(o.MysticArcanumLevel9) {
		var ret float32
		return ret
	}
	return *o.MysticArcanumLevel9
}

// GetMysticArcanumLevel9Ok returns a tuple with the MysticArcanumLevel9 field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClassLevelClassSpecificAnyOf10) GetMysticArcanumLevel9Ok() (*float32, bool) {
	if o == nil || isNil(o.MysticArcanumLevel9) {
    return nil, false
	}
	return o.MysticArcanumLevel9, true
}
...
// SetMysticArcanumLevel9 gets a reference to the given float32 and assigns it to the MysticArcanumLevel9 field.
func (o *ClassLevelClassSpecificAnyOf10) SetMysticArcanumLevel9(v float32) {
	o.MysticArcanumLevel9 = &v
}

func (o ClassLevelClassSpecificAnyOf10) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.InvocationsKnown) {
		toSerialize["invocations_known"] = o.InvocationsKnown
	}
	if !isNil(o.MysticArcanumLevel6) {
		toSerialize["mystic_arcanum_level_6"] = o.MysticArcanumLevel6
	}
	if !isNil(o.MysticArcanumLevel7) {
		toSerialize["mystic_arcanum_level_7"] = o.MysticArcanumLevel7
	}
	if !isNil(o.MysticArcanumLevel8) {
		toSerialize["mystic_arcanum_level_8"] = o.MysticArcanumLevel8
	}
	if !isNil(o.MysticArcanumLevel9) {
		toSerialize["mystic_arcanum_level_9"] = o.MysticArcanumLevel9
	}
	return json.Marshal(toSerialize)
}

type NullableClassLevelClassSpecificAnyOf10 struct {
	value *ClassLevelClassSpecificAnyOf10
	isSet bool
}

func (v NullableClassLevelClassSpecificAnyOf10) Get() *ClassLevelClassSpecificAnyOf10 {
	return v.value
}

func (v *NullableClassLevelClassSpecificAnyOf10) Set(val *ClassLevelClassSpecificAnyOf10) {
	v.value = val
	v.isSet = true
}

func (v NullableClassLevelClassSpecificAnyOf10) IsSet() bool {
	return v.isSet
}

func (v *NullableClassLevelClassSpecificAnyOf10) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClassLevelClassSpecificAnyOf10(val *ClassLevelClassSpecificAnyOf10) *NullableClassLevelClassSpecificAnyOf10 {
	return &NullableClassLevelClassSpecificAnyOf10{value: val, isSet: true}
}

func (v NullableClassLevelClassSpecificAnyOf10) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClassLevelClassSpecificAnyOf10) UnmarshalJSON(src []byte) error {
	v.isSet = true
