...
// SubracesApiService SubracesApi service
type SubracesApiService service

type ApiApiSubracesIndexGetRequest struct {
	ctx context.Context
	ApiService *SubracesApiService
	index string
}

func (r ApiApiSubracesIndexGetRequest) Execute() (*Subrace, *http.Response, error) {
	return r.ApiService.ApiSubracesIndexGetExecute(r)
}

/*
ApiSubracesIndexGet Get a subrace by index.
...
Subraces reflect the different varieties of a certain parent race.
 ...
 @return ApiApiSubracesIndexGetRequest
*/
func (a *SubracesApiService) ApiSubracesIndexGet(ctx context.Context, index string) ApiApiSubracesIndexGetRequest {
	return ApiApiSubracesIndexGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
//  @return Subrace
func (a *SubracesApiService) ApiSubracesIndexGetExecute(r ApiApiSubracesIndexGetRequest) (*Subrace, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *Subrace
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubracesApiService.ApiSubracesIndexGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/subraces/{index}"
...
type ApiApiSubracesIndexProficienciesGetRequest struct {
	ctx context.Context
	ApiService *SubracesApiService
	index string
}

func (r ApiApiSubracesIndexProficienciesGetRequest) Execute() (*APIReferenceList, *http.Response, error) {
	return r.ApiService.ApiSubracesIndexProficienciesGetExecute(r)
}

/*
ApiSubracesIndexProficienciesGet Get proficiences available for a subrace.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the subrace to get. 
 @return ApiApiSubracesIndexProficienciesGetRequest
*/
func (a *SubracesApiService) ApiSubracesIndexProficienciesGet(ctx context.Context, index string) ApiApiSubracesIndexProficienciesGetRequest {
	return ApiApiSubracesIndexProficienciesGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
func (a *SubracesApiService) ApiSubracesIndexProficienciesGetExecute(r ApiApiSubracesIndexProficienciesGetRequest) (*APIReferenceList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubracesApiService.ApiSubracesIndexProficienciesGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/subraces/{index}/proficiencies"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
...
type ApiApiSubracesIndexTraitsGetRequest struct {
	ctx context.Context
	ApiService *SubracesApiService
	index string
}

func (r ApiApiSubracesIndexTraitsGetRequest) Execute() (*APIReferenceList, *http.Response, error) {
	return r.ApiService.ApiSubracesIndexTraitsGetExecute(r)
}

/*
ApiSubracesIndexTraitsGet Get traits available for a subrace.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the subrace to get. 
 @return ApiApiSubracesIndexTraitsGetRequest
*/
func (a *SubracesApiService) ApiSubracesIndexTraitsGet(ctx context.Context, index string) ApiApiSubracesIndexTraitsGetRequest {
	return ApiApiSubracesIndexTraitsGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
// Execute executes the request
//  @return APIReferenceList
func (a *SubracesApiService) ApiSubracesIndexTraitsGetExecute(r ApiApiSubracesIndexTraitsGetRequest) (*APIReferenceList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubracesApiService.ApiSubracesIndexTraitsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/subraces/{index}/traits"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
