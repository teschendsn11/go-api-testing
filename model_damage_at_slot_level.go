...
// GetDamageAtSlotLevel returns the DamageAtSlotLevel field value if set, zero value otherwise.
func (o *DamageAtSlotLevel) GetDamageAtSlotLevel() map[string]interface{} {
	if o == nil || isNil(o.DamageAtSlotLevel) {
		var ret map[string]interface{}
		return ret
	}
	return o.DamageAtSlotLevel
}

// GetDamageAtSlotLevelOk returns a tuple with the DamageAtSlotLevel field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DamageAtSlotLevel) GetDamageAtSlotLevelOk() (map[string]interface{}, bool) {
	if o == nil || isNil(o.DamageAtSlotLevel) {
    return map[string]interface{}{}, false
	}
	return o.DamageAtSlotLevel, true
}
...
// SetDamageAtSlotLevel gets a reference to the given map[string]interface{} and assigns it to the DamageAtSlotLevel field.
func (o *DamageAtSlotLevel) SetDamageAtSlotLevel(v map[string]interface{}) {
	o.DamageAtSlotLevel = v
}
...
func (o DamageAtSlotLevel) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.DamageAtSlotLevel) {
		toSerialize["damage_at_slot_level"] = o.DamageAtSlotLevel
	}
...
type NullableDamageAtSlotLevel struct {
	value *DamageAtSlotLevel
	isSet bool
}

func (v NullableDamageAtSlotLevel) Get() *DamageAtSlotLevel {
	return v.value
}

func (v *NullableDamageAtSlotLevel) Set(val *DamageAtSlotLevel) {
	v.value = val
	v.isSet = true
}

func (v NullableDamageAtSlotLevel) IsSet() bool {
	return v.isSet
}

func (v *NullableDamageAtSlotLevel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDamageAtSlotLevel(val *DamageAtSlotLevel) *NullableDamageAtSlotLevel {
	return &NullableDamageAtSlotLevel{value: val, isSet: true}
}

func (v NullableDamageAtSlotLevel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDamageAtSlotLevel) UnmarshalJSON(src []byte) error {
	v.isSet = true
