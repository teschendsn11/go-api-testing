...
// MonsterAllOf1Spellcasting struct for MonsterAllOf1Spellcasting
type MonsterAllOf1Spellcasting struct {
	...
	Spells []MonsterAllOf1SpellcastingSpells `json:"spells,omitempty"`
}
...
func NewMonsterAllOf1Spellcasting() *MonsterAllOf1Spellcasting {
	this := MonsterAllOf1Spellcasting{}
	return &this
}
...
// SetAbility gets a reference to the given APIReference and assigns it to the Ability field.
...
// SetDc gets a reference to the given float32 and assigns it to the Dc field.
...
// SetModifier gets a reference to the given float32 and assigns it to the Modifier field.
func (o *MonsterAllOf1Spellcasting) SetModifier(v float32) {
	o.Modifier = &v
}

// GetComponentsRequired returns the ComponentsRequired field value if set, zero value otherwise.
func (o *MonsterAllOf1Spellcasting) GetComponentsRequired() []string {
	if o == nil || isNil(o.ComponentsRequired) {
		var ret []string
		return ret
	}
	return o.ComponentsRequired
}

// GetComponentsRequiredOk returns a tuple with the ComponentsRequired field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MonsterAllOf1Spellcasting) GetComponentsRequiredOk() ([]string, bool) {
	if o == nil || isNil(o.ComponentsRequired) {
    return nil, false
	}
	return o.ComponentsRequired, true
}
...
// SetComponentsRequired gets a reference to the given []string and assigns it to the ComponentsRequired field.
func (o *MonsterAllOf1Spellcasting) SetComponentsRequired(v []string) {
	o.ComponentsRequired = v
}
...
// SetSlots gets a reference to the given map[string]float32 and assigns it to the Slots field.
...
func (o *MonsterAllOf1Spellcasting) GetSpells() []MonsterAllOf1SpellcastingSpells {
	if o == nil || isNil(o.Spells) {
		var ret []MonsterAllOf1SpellcastingSpells
		return ret
	}
	return o.Spells
}
...
// SetSpells gets a reference to the given []MonsterAllOf1SpellcastingSpells and assigns it to the Spells field.
func (o *MonsterAllOf1Spellcasting) SetSpells(v []MonsterAllOf1SpellcastingSpells) {
	o.Spells = v
}

func (o MonsterAllOf1Spellcasting) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.ComponentsRequired) {
		toSerialize["components_required"] = o.ComponentsRequired
	}
	if !isNil(o.School) {
...
type NullableMonsterAllOf1Spellcasting struct {
	value *MonsterAllOf1Spellcasting
	isSet bool
}

func (v NullableMonsterAllOf1Spellcasting) Get() *MonsterAllOf1Spellcasting {
	return v.value
}

func (v *NullableMonsterAllOf1Spellcasting) Set(val *MonsterAllOf1Spellcasting) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterAllOf1Spellcasting) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterAllOf1Spellcasting) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterAllOf1Spellcasting(val *MonsterAllOf1Spellcasting) *NullableMonsterAllOf1Spellcasting {
	return &NullableMonsterAllOf1Spellcasting{value: val, isSet: true}
}

func (v NullableMonsterAllOf1Spellcasting) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterAllOf1Spellcasting) UnmarshalJSON(src []byte) error {
	v.isSet = true
