...
// MonsterAllOf1Attacks struct for MonsterAllOf1Attacks
type MonsterAllOf1Attacks struct {
	Name *string `json:"name,omitempty"`
	Dc *DC `json:"dc,omitempty"`
	Damage *APIReference `json:"damage,omitempty"`
}
...
// SetDamage gets a reference to the given APIReference and assigns it to the Damage field.
func (o *MonsterAllOf1Attacks) SetDamage(v APIReference) {
	o.Damage = &v
}

func (o MonsterAllOf1Attacks) MarshalJSON() ([]byte, error) {
...
type NullableMonsterAllOf1Attacks struct {
	value *MonsterAllOf1Attacks
	isSet bool
}

func (v NullableMonsterAllOf1Attacks) Get() *MonsterAllOf1Attacks {
	return v.value
}

func (v *NullableMonsterAllOf1Attacks) Set(val *MonsterAllOf1Attacks) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterAllOf1Attacks) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterAllOf1Attacks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterAllOf1Attacks(val *MonsterAllOf1Attacks) *NullableMonsterAllOf1Attacks {
	return &NullableMonsterAllOf1Attacks{value: val, isSet: true}
}

func (v NullableMonsterAllOf1Attacks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterAllOf1Attacks) UnmarshalJSON(src []byte) error {
	v.isSet = true
