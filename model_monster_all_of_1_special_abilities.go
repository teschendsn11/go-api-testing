...
// MonsterAllOf1SpecialAbilities struct for MonsterAllOf1SpecialAbilities
type MonsterAllOf1SpecialAbilities struct {
	Name *string `json:"name,omitempty"`
	Desc *string `json:"desc,omitempty"`
	AttackBonus *float32 `json:"attack_bonus,omitempty"`
	Damage []Damage `json:"damage,omitempty"`
	Dc *DC `json:"dc,omitempty"`
	Spellcasting *MonsterAllOf1Spellcasting `json:"spellcasting,omitempty"`
	Usage *MonsterAllOf1Usage `json:"usage,omitempty"`
}
...
func NewMonsterAllOf1SpecialAbilities() *MonsterAllOf1SpecialAbilities {
	this := MonsterAllOf1SpecialAbilities{}
	return &this
}
...
func (o *MonsterAllOf1SpecialAbilities) GetSpellcasting() MonsterAllOf1Spellcasting {
	if o == nil || isNil(o.Spellcasting) {
		var ret MonsterAllOf1Spellcasting
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *MonsterAllOf1SpecialAbilities) GetSpellcastingOk() (*MonsterAllOf1Spellcasting, bool) {
	if o == nil || isNil(o.Spellcasting) {
    return nil, false
	}
...
// SetSpellcasting gets a reference to the given MonsterAllOf1Spellcasting and assigns it to the Spellcasting field.
...
// SetUsage gets a reference to the given MonsterAllOf1Usage and assigns it to the Usage field.
func (o *MonsterAllOf1SpecialAbilities) SetUsage(v MonsterAllOf1Usage) {
	o.Usage = &v
}

func (o MonsterAllOf1SpecialAbilities) MarshalJSON() ([]byte, error) {
...
type NullableMonsterAllOf1SpecialAbilities struct {
	value *MonsterAllOf1SpecialAbilities
	isSet bool
}

func (v NullableMonsterAllOf1SpecialAbilities) Get() *MonsterAllOf1SpecialAbilities {
	return v.value
}

func (v *NullableMonsterAllOf1SpecialAbilities) Set(val *MonsterAllOf1SpecialAbilities) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterAllOf1SpecialAbilities) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterAllOf1SpecialAbilities) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterAllOf1SpecialAbilities(val *MonsterAllOf1SpecialAbilities) *NullableMonsterAllOf1SpecialAbilities {
	return &NullableMonsterAllOf1SpecialAbilities{value: val, isSet: true}
}

func (v NullableMonsterAllOf1SpecialAbilities) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterAllOf1SpecialAbilities) UnmarshalJSON(src []byte) error {
	v.isSet = true
