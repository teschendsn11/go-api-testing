...
// EquipmentCategoryAllOf struct for EquipmentCategoryAllOf
type EquipmentCategoryAllOf struct {
...
func (o EquipmentCategoryAllOf) MarshalJSON() ([]byte, error) {
...
type NullableEquipmentCategoryAllOf struct {
	value *EquipmentCategoryAllOf
	isSet bool
}

func (v NullableEquipmentCategoryAllOf) Get() *EquipmentCategoryAllOf {
	return v.value
}

func (v *NullableEquipmentCategoryAllOf) Set(val *EquipmentCategoryAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableEquipmentCategoryAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableEquipmentCategoryAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEquipmentCategoryAllOf(val *EquipmentCategoryAllOf) *NullableEquipmentCategoryAllOf {
	return &NullableEquipmentCategoryAllOf{value: val, isSet: true}
}

func (v NullableEquipmentCategoryAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEquipmentCategoryAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
