...
// OptionOneOf8 struct for OptionOneOf8
type OptionOneOf8 struct {
...
// SetBonus gets a reference to the given float32 and assigns it to the Bonus field.
func (o *OptionOneOf8) SetBonus(v float32) {
	o.Bonus = &v
}

func (o OptionOneOf8) MarshalJSON() ([]byte, error) {
...
type NullableOptionOneOf8 struct {
	value *OptionOneOf8
	isSet bool
}

func (v NullableOptionOneOf8) Get() *OptionOneOf8 {
	return v.value
}

func (v *NullableOptionOneOf8) Set(val *OptionOneOf8) {
	v.value = val
	v.isSet = true
}

func (v NullableOptionOneOf8) IsSet() bool {
	return v.isSet
}

func (v *NullableOptionOneOf8) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptionOneOf8(val *OptionOneOf8) *NullableOptionOneOf8 {
	return &NullableOptionOneOf8{value: val, isSet: true}
}

func (v NullableOptionOneOf8) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptionOneOf8) UnmarshalJSON(src []byte) error {
	v.isSet = true
