...
// OptionOneOf6 struct for OptionOneOf6
type OptionOneOf6 struct {
...
// SetOf gets a reference to the given APIReference and assigns it to the Of field.
func (o *OptionOneOf6) SetOf(v APIReference) {
	o.Of = &v
}

func (o OptionOneOf6) MarshalJSON() ([]byte, error) {
...
type NullableOptionOneOf6 struct {
	value *OptionOneOf6
	isSet bool
}

func (v NullableOptionOneOf6) Get() *OptionOneOf6 {
	return v.value
}

func (v *NullableOptionOneOf6) Set(val *OptionOneOf6) {
	v.value = val
	v.isSet = true
}

func (v NullableOptionOneOf6) IsSet() bool {
	return v.isSet
}

func (v *NullableOptionOneOf6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptionOneOf6(val *OptionOneOf6) *NullableOptionOneOf6 {
	return &NullableOptionOneOf6{value: val, isSet: true}
}

func (v NullableOptionOneOf6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptionOneOf6) UnmarshalJSON(src []byte) error {
	v.isSet = true
