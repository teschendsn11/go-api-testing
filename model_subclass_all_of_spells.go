...
// SubclassAllOfSpells struct for SubclassAllOfSpells
type SubclassAllOfSpells struct {
...
// SetPrerequisites gets a reference to the given []SpellPrerequisite and assigns it to the Prerequisites field.
func (o *SubclassAllOfSpells) SetPrerequisites(v []SpellPrerequisite) {
	o.Prerequisites = v
}

// GetSpell returns the Spell field value if set, zero value otherwise.
func (o *SubclassAllOfSpells) GetSpell() APIReference {
	if o == nil || isNil(o.Spell) {
...
// GetSpellOk returns a tuple with the Spell field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetSpell gets a reference to the given APIReference and assigns it to the Spell field.
func (o *SubclassAllOfSpells) SetSpell(v APIReference) {
	o.Spell = &v
}

func (o SubclassAllOfSpells) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.Prerequisites) {
		toSerialize["prerequisites"] = o.Prerequisites
	}
	if !isNil(o.Spell) {
		toSerialize["spell"] = o.Spell
	}
	return json.Marshal(toSerialize)
}

type NullableSubclassAllOfSpells struct {
	value *SubclassAllOfSpells
	isSet bool
}

func (v NullableSubclassAllOfSpells) Get() *SubclassAllOfSpells {
	return v.value
}

func (v *NullableSubclassAllOfSpells) Set(val *SubclassAllOfSpells) {
	v.value = val
	v.isSet = true
}

func (v NullableSubclassAllOfSpells) IsSet() bool {
	return v.isSet
}

func (v *NullableSubclassAllOfSpells) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubclassAllOfSpells(val *SubclassAllOfSpells) *NullableSubclassAllOfSpells {
	return &NullableSubclassAllOfSpells{value: val, isSet: true}
}

func (v NullableSubclassAllOfSpells) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubclassAllOfSpells) UnmarshalJSON(src []byte) error {
	v.isSet = true
