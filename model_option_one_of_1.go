...
// OptionOneOf1 struct for OptionOneOf1
type OptionOneOf1 struct {
...
func (o OptionOneOf1) MarshalJSON() ([]byte, error) {
...
type NullableOptionOneOf1 struct {
	value *OptionOneOf1
	isSet bool
}

func (v NullableOptionOneOf1) Get() *OptionOneOf1 {
	return v.value
}

func (v *NullableOptionOneOf1) Set(val *OptionOneOf1) {
	v.value = val
	v.isSet = true
}

func (v NullableOptionOneOf1) IsSet() bool {
	return v.isSet
}

func (v *NullableOptionOneOf1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptionOneOf1(val *OptionOneOf1) *NullableOptionOneOf1 {
	return &NullableOptionOneOf1{value: val, isSet: true}
}

func (v NullableOptionOneOf1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptionOneOf1) UnmarshalJSON(src []byte) error {
	v.isSet = true
