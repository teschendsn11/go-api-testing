...
// MonsterAllOf1Usage struct for MonsterAllOf1Usage
type MonsterAllOf1Usage struct {
...
// GetRestTypes returns the RestTypes field value if set, zero value otherwise.
func (o *MonsterAllOf1Usage) GetRestTypes() []string {
	if o == nil || isNil(o.RestTypes) {
		var ret []string
		return ret
	}
	return o.RestTypes
...
// GetRestTypesOk returns a tuple with the RestTypes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MonsterAllOf1Usage) GetRestTypesOk() ([]string, bool) {
	if o == nil || isNil(o.RestTypes) {
    return nil, false
	}
	return o.RestTypes, true
}
...
// SetRestTypes gets a reference to the given []string and assigns it to the RestTypes field.
...
func (o MonsterAllOf1Usage) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.Type) {
		toSerialize["type"] = o.Type
	}
	if !isNil(o.RestTypes) {
		toSerialize["rest_types"] = o.RestTypes
	}
	if !isNil(o.Times) {
...
type NullableMonsterAllOf1Usage struct {
	value *MonsterAllOf1Usage
	isSet bool
}

func (v NullableMonsterAllOf1Usage) Get() *MonsterAllOf1Usage {
	return v.value
}

func (v *NullableMonsterAllOf1Usage) Set(val *MonsterAllOf1Usage) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterAllOf1Usage) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterAllOf1Usage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterAllOf1Usage(val *MonsterAllOf1Usage) *NullableMonsterAllOf1Usage {
	return &NullableMonsterAllOf1Usage{value: val, isSet: true}
}

func (v NullableMonsterAllOf1Usage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterAllOf1Usage) UnmarshalJSON(src []byte) error {
	v.isSet = true
