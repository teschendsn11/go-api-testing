...
// ClassLevelClassSpecificAnyOf8 Bard Rogue Specific Features
type ClassLevelClassSpecificAnyOf8 struct {
	SneakAttack *ClassLevelClassSpecificAnyOf5MartialArts `json:"sneak_attack,omitempty"`
}
...
func NewClassLevelClassSpecificAnyOf8() *ClassLevelClassSpecificAnyOf8 {
	this := ClassLevelClassSpecificAnyOf8{}
	return &this
}
...
// SetSneakAttack gets a reference to the given ClassLevelClassSpecificAnyOf5MartialArts and assigns it to the SneakAttack field.
func (o *ClassLevelClassSpecificAnyOf8) SetSneakAttack(v ClassLevelClassSpecificAnyOf5MartialArts) {
	o.SneakAttack = &v
}

func (o ClassLevelClassSpecificAnyOf8) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.SneakAttack) {
		toSerialize["sneak_attack"] = o.SneakAttack
	}
	return json.Marshal(toSerialize)
}

type NullableClassLevelClassSpecificAnyOf8 struct {
	value *ClassLevelClassSpecificAnyOf8
	isSet bool
}

func (v NullableClassLevelClassSpecificAnyOf8) Get() *ClassLevelClassSpecificAnyOf8 {
	return v.value
}

func (v *NullableClassLevelClassSpecificAnyOf8) Set(val *ClassLevelClassSpecificAnyOf8) {
	v.value = val
	v.isSet = true
}

func (v NullableClassLevelClassSpecificAnyOf8) IsSet() bool {
	return v.isSet
}

func (v *NullableClassLevelClassSpecificAnyOf8) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClassLevelClassSpecificAnyOf8(val *ClassLevelClassSpecificAnyOf8) *NullableClassLevelClassSpecificAnyOf8 {
	return &NullableClassLevelClassSpecificAnyOf8{value: val, isSet: true}
}

func (v NullableClassLevelClassSpecificAnyOf8) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClassLevelClassSpecificAnyOf8) UnmarshalJSON(src []byte) error {
	v.isSet = true
