...
type ApiApiEndpointGetRequest struct {
	ctx context.Context
	ApiService *CommonApiService
	endpoint string
}

func (r ApiApiEndpointGetRequest) Execute() (*APIReferenceList, *http.Response, error) {
	return r.ApiService.ApiEndpointGetExecute(r)
}

/*
ApiEndpointGet Get list of all available resources for an endpoint.
...
Currently only the [`/spells`](#get-/api/spells) and [`/monsters`](#get-/api/monsters) endpoints support filtering with query parameters. Use of these query parameters is documented under the respective [Spells](#tag--Spells) and [Monsters](#tag--Monsters) sections.
 ...
 @param endpoint
 @return ApiApiEndpointGetRequest
*/
func (a *CommonApiService) ApiEndpointGet(ctx context.Context, endpoint string) ApiApiEndpointGetRequest {
	return ApiApiEndpointGetRequest{
		ApiService: a,
		ctx: ctx,
		endpoint: endpoint,
...
func (a *CommonApiService) ApiEndpointGetExecute(r ApiApiEndpointGetRequest) (*APIReferenceList, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CommonApiService.ApiEndpointGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/{endpoint}"
	localVarPath = strings.Replace(localVarPath, "{"+"endpoint"+"}", url.PathEscape(parameterToString(r.endpoint, "")), -1)
...
func (r ApiApiGetRequest) Execute() (map[string]string, *http.Response, error) {
	return r.ApiService.ApiGetExecute(r)
}

/*
ApiGet Get all resource URLs.
...
*/
func (a *CommonApiService) ApiGet(ctx context.Context) ApiApiGetRequest {
	return ApiApiGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CommonApiService) ApiGetExecute(r ApiApiGetRequest) (map[string]string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CommonApiService.ApiGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
