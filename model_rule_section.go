...
func (o RuleSection) MarshalJSON() ([]byte, error) {
...
type NullableRuleSection struct {
	value *RuleSection
	isSet bool
}

func (v NullableRuleSection) Get() *RuleSection {
	return v.value
}

func (v *NullableRuleSection) Set(val *RuleSection) {
	v.value = val
	v.isSet = true
}

func (v NullableRuleSection) IsSet() bool {
	return v.isSet
}

func (v *NullableRuleSection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuleSection(val *RuleSection) *NullableRuleSection {
	return &NullableRuleSection{value: val, isSet: true}
}

func (v NullableRuleSection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuleSection) UnmarshalJSON(src []byte) error {
	v.isSet = true
