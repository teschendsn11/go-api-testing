...
// SubclassesApiService SubclassesApi service
type SubclassesApiService service

type ApiApiSubclassesIndexFeaturesGetRequest struct {
	ctx context.Context
	ApiService *SubclassesApiService
	index string
}

func (r ApiApiSubclassesIndexFeaturesGetRequest) Execute() (*APIReferenceList, *http.Response, error) {
	return r.ApiService.ApiSubclassesIndexFeaturesGetExecute(r)
}

/*
ApiSubclassesIndexFeaturesGet Get features available for a subclass.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the subclass to get. 
 @return ApiApiSubclassesIndexFeaturesGetRequest
*/
func (a *SubclassesApiService) ApiSubclassesIndexFeaturesGet(ctx context.Context, index string) ApiApiSubclassesIndexFeaturesGetRequest {
	return ApiApiSubclassesIndexFeaturesGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
func (a *SubclassesApiService) ApiSubclassesIndexFeaturesGetExecute(r ApiApiSubclassesIndexFeaturesGetRequest) (*APIReferenceList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *APIReferenceList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubclassesApiService.ApiSubclassesIndexFeaturesGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/subclasses/{index}/features"
...
type ApiApiSubclassesIndexGetRequest struct {
	ctx context.Context
	ApiService *SubclassesApiService
	index string
}

func (r ApiApiSubclassesIndexGetRequest) Execute() (*Subclass, *http.Response, error) {
	return r.ApiService.ApiSubclassesIndexGetExecute(r)
}

/*
ApiSubclassesIndexGet Get a subclass by index.

Subclasses reflect the different paths a class may take as levels are gained.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the subclass to get. 
 @return ApiApiSubclassesIndexGetRequest
*/
func (a *SubclassesApiService) ApiSubclassesIndexGet(ctx context.Context, index string) ApiApiSubclassesIndexGetRequest {
	return ApiApiSubclassesIndexGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
// Execute executes the request
//  @return Subclass
func (a *SubclassesApiService) ApiSubclassesIndexGetExecute(r ApiApiSubclassesIndexGetRequest) (*Subclass, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *Subclass
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubclassesApiService.ApiSubclassesIndexGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/subclasses/{index}"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
...
type ApiApiSubclassesIndexLevelsGetRequest struct {
	ctx context.Context
	ApiService *SubclassesApiService
	index string
}

func (r ApiApiSubclassesIndexLevelsGetRequest) Execute() ([]SubclassLevelResource, *http.Response, error) {
	return r.ApiService.ApiSubclassesIndexLevelsGetExecute(r)
}

/*
ApiSubclassesIndexLevelsGet Get all level resources for a subclass.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the subclass to get. 
 @return ApiApiSubclassesIndexLevelsGetRequest
*/
func (a *SubclassesApiService) ApiSubclassesIndexLevelsGet(ctx context.Context, index string) ApiApiSubclassesIndexLevelsGetRequest {
	return ApiApiSubclassesIndexLevelsGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
func (a *SubclassesApiService) ApiSubclassesIndexLevelsGetExecute(r ApiApiSubclassesIndexLevelsGetRequest) ([]SubclassLevelResource, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []SubclassLevelResource
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubclassesApiService.ApiSubclassesIndexLevelsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/subclasses/{index}/levels"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
...
type ApiApiSubclassesIndexLevelsSubclassLevelFeaturesGetRequest struct {
	ctx context.Context
	ApiService *SubclassesApiService
	index string
	subclassLevel int32
...
func (r ApiApiSubclassesIndexLevelsSubclassLevelFeaturesGetRequest) Execute() (*APIReferenceList, *http.Response, error) {
	return r.ApiService.ApiSubclassesIndexLevelsSubclassLevelFeaturesGetExecute(r)
}

/*
ApiSubclassesIndexLevelsSubclassLevelFeaturesGet Get features of the requested spell level available to the class.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the subclass to get. 
 @param subclassLevel
 @return ApiApiSubclassesIndexLevelsSubclassLevelFeaturesGetRequest
*/
func (a *SubclassesApiService) ApiSubclassesIndexLevelsSubclassLevelFeaturesGet(ctx context.Context, index string, subclassLevel int32) ApiApiSubclassesIndexLevelsSubclassLevelFeaturesGetRequest {
	return ApiApiSubclassesIndexLevelsSubclassLevelFeaturesGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
// Execute executes the request
//  @return APIReferenceList
func (a *SubclassesApiService) ApiSubclassesIndexLevelsSubclassLevelFeaturesGetExecute(r ApiApiSubclassesIndexLevelsSubclassLevelFeaturesGetRequest) (*APIReferenceList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubclassesApiService.ApiSubclassesIndexLevelsSubclassLevelFeaturesGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/subclasses/{index}/levels/{subclass_level}/features"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"subclass_level"+"}", url.PathEscape(parameterToString(r.subclassLevel, "")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.subclassLevel < 0 {
		return localVarReturnValue, nil, reportError("subclassLevel must be greater than 0")
	}
	if r.subclassLevel > 20 {
		return localVarReturnValue, nil, reportError("subclassLevel must be less than 20")
	}
...
type ApiApiSubclassesIndexLevelsSubclassLevelGetRequest struct {
	ctx context.Context
	ApiService *SubclassesApiService
	index string
	subclassLevel int32
...
func (r ApiApiSubclassesIndexLevelsSubclassLevelGetRequest) Execute() (*SubclassLevel, *http.Response, error) {
	return r.ApiService.ApiSubclassesIndexLevelsSubclassLevelGetExecute(r)
}

/*
ApiSubclassesIndexLevelsSubclassLevelGet Get level resources for a subclass and level.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param index The `index` of the subclass to get. 
 @param subclassLevel
 @return ApiApiSubclassesIndexLevelsSubclassLevelGetRequest
*/
func (a *SubclassesApiService) ApiSubclassesIndexLevelsSubclassLevelGet(ctx context.Context, index string, subclassLevel int32) ApiApiSubclassesIndexLevelsSubclassLevelGetRequest {
	return ApiApiSubclassesIndexLevelsSubclassLevelGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
func (a *SubclassesApiService) ApiSubclassesIndexLevelsSubclassLevelGetExecute(r ApiApiSubclassesIndexLevelsSubclassLevelGetRequest) (*SubclassLevel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SubclassLevel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubclassesApiService.ApiSubclassesIndexLevelsSubclassLevelGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/subclasses/{index}/levels/{subclass_level}"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"subclass_level"+"}", url.PathEscape(parameterToString(r.subclassLevel, "")), -1)
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.subclassLevel < 1 {
		return localVarReturnValue, nil, reportError("subclassLevel must be greater than 1")
	}
	if r.subclassLevel > 20 {
		return localVarReturnValue, nil, reportError("subclassLevel must be less than 20")
	}
