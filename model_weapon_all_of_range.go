...
// WeaponAllOfRange struct for WeaponAllOfRange
type WeaponAllOfRange struct {
...
// SetNormal gets a reference to the given float32 and assigns it to the Normal field.
...
func (o WeaponAllOfRange) MarshalJSON() ([]byte, error) {
...
type NullableWeaponAllOfRange struct {
	value *WeaponAllOfRange
	isSet bool
}

func (v NullableWeaponAllOfRange) Get() *WeaponAllOfRange {
	return v.value
}

func (v *NullableWeaponAllOfRange) Set(val *WeaponAllOfRange) {
	v.value = val
	v.isSet = true
}

func (v NullableWeaponAllOfRange) IsSet() bool {
	return v.isSet
}

func (v *NullableWeaponAllOfRange) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWeaponAllOfRange(val *WeaponAllOfRange) *NullableWeaponAllOfRange {
	return &NullableWeaponAllOfRange{value: val, isSet: true}
}

func (v NullableWeaponAllOfRange) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWeaponAllOfRange) UnmarshalJSON(src []byte) error {
	v.isSet = true
