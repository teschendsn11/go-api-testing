...
// AbilityScoreAllOf struct for AbilityScoreAllOf
type AbilityScoreAllOf struct {
...
// SetSkills gets a reference to the given []APIReference and assigns it to the Skills field.
func (o *AbilityScoreAllOf) SetSkills(v []APIReference) {
	o.Skills = v
}

func (o AbilityScoreAllOf) MarshalJSON() ([]byte, error) {
...
type NullableAbilityScoreAllOf struct {
	value *AbilityScoreAllOf
	isSet bool
}

func (v NullableAbilityScoreAllOf) Get() *AbilityScoreAllOf {
	return v.value
}

func (v *NullableAbilityScoreAllOf) Set(val *AbilityScoreAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableAbilityScoreAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableAbilityScoreAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAbilityScoreAllOf(val *AbilityScoreAllOf) *NullableAbilityScoreAllOf {
	return &NullableAbilityScoreAllOf{value: val, isSet: true}
}

func (v NullableAbilityScoreAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAbilityScoreAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
