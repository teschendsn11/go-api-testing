...
// SubraceAllOf struct for SubraceAllOf
type SubraceAllOf struct {
...
// SetRace gets a reference to the given APIReference and assigns it to the Race field.
...
func (o SubraceAllOf) MarshalJSON() ([]byte, error) {
...
type NullableSubraceAllOf struct {
	value *SubraceAllOf
	isSet bool
}

func (v NullableSubraceAllOf) Get() *SubraceAllOf {
	return v.value
}

func (v *NullableSubraceAllOf) Set(val *SubraceAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSubraceAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSubraceAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubraceAllOf(val *SubraceAllOf) *NullableSubraceAllOf {
	return &NullableSubraceAllOf{value: val, isSet: true}
}

func (v NullableSubraceAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubraceAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
