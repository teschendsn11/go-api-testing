...
func (o AbilityScore) MarshalJSON() ([]byte, error) {
...
type NullableAbilityScore struct {
	value *AbilityScore
	isSet bool
}

func (v NullableAbilityScore) Get() *AbilityScore {
	return v.value
}

func (v *NullableAbilityScore) Set(val *AbilityScore) {
	v.value = val
	v.isSet = true
}

func (v NullableAbilityScore) IsSet() bool {
	return v.isSet
}

func (v *NullableAbilityScore) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAbilityScore(val *AbilityScore) *NullableAbilityScore {
	return &NullableAbilityScore{value: val, isSet: true}
}

func (v NullableAbilityScore) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAbilityScore) UnmarshalJSON(src []byte) error {
	v.isSet = true
