...
// AbilityBonus struct for AbilityBonus
...
func (o AbilityBonus) MarshalJSON() ([]byte, error) {
...
type NullableAbilityBonus struct {
	value *AbilityBonus
	isSet bool
}

func (v NullableAbilityBonus) Get() *AbilityBonus {
	return v.value
}

func (v *NullableAbilityBonus) Set(val *AbilityBonus) {
	v.value = val
	v.isSet = true
}

func (v NullableAbilityBonus) IsSet() bool {
	return v.isSet
}

func (v *NullableAbilityBonus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAbilityBonus(val *AbilityBonus) *NullableAbilityBonus {
	return &NullableAbilityBonus{value: val, isSet: true}
}

func (v NullableAbilityBonus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAbilityBonus) UnmarshalJSON(src []byte) error {
	v.isSet = true
