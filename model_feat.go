...
func (o Feat) MarshalJSON() ([]byte, error) {
...
type NullableFeat struct {
	value *Feat
	isSet bool
}

func (v NullableFeat) Get() *Feat {
	return v.value
}

func (v *NullableFeat) Set(val *Feat) {
	v.value = val
	v.isSet = true
}

func (v NullableFeat) IsSet() bool {
	return v.isSet
}

func (v *NullableFeat) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFeat(val *Feat) *NullableFeat {
	return &NullableFeat{value: val, isSet: true}
}

func (v NullableFeat) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFeat) UnmarshalJSON(src []byte) error {
	v.isSet = true
