...
type ApiApiRuleSectionsIndexGetRequest struct {
	ctx context.Context
	ApiService *RulesApiService
	index string
}

func (r ApiApiRuleSectionsIndexGetRequest) Execute() (*RuleSection, *http.Response, error) {
	return r.ApiService.ApiRuleSectionsIndexGetExecute(r)
}

/*
ApiRuleSectionsIndexGet Get a rule section by index.
...
Rule sections represent a sub-heading and text that can be found underneath a rule heading in the SRD.
 ...
 @return ApiApiRuleSectionsIndexGetRequest
*/
func (a *RulesApiService) ApiRuleSectionsIndexGet(ctx context.Context, index string) ApiApiRuleSectionsIndexGetRequest {
	return ApiApiRuleSectionsIndexGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
//  @return RuleSection
func (a *RulesApiService) ApiRuleSectionsIndexGetExecute(r ApiApiRuleSectionsIndexGetRequest) (*RuleSection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *RuleSection
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RulesApiService.ApiRuleSectionsIndexGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/rule-sections/{index}"
...
type ApiApiRulesIndexGetRequest struct {
	ctx context.Context
	ApiService *RulesApiService
	index string
}

func (r ApiApiRulesIndexGetRequest) Execute() (*Rule, *http.Response, error) {
	return r.ApiService.ApiRulesIndexGetExecute(r)
}

/*
ApiRulesIndexGet Get a rule by index.
...
in the SRD. Rules also have subsections for each heading underneath the rule in the SRD.
 ...
 @return ApiApiRulesIndexGetRequest
*/
func (a *RulesApiService) ApiRulesIndexGet(ctx context.Context, index string) ApiApiRulesIndexGetRequest {
	return ApiApiRulesIndexGetRequest{
		ApiService: a,
		ctx: ctx,
		index: index,
...
// Execute executes the request
//  @return Rule
func (a *RulesApiService) ApiRulesIndexGetExecute(r ApiApiRulesIndexGetRequest) (*Rule, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RulesApiService.ApiRulesIndexGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/rules/{index}"
	localVarPath = strings.Replace(localVarPath, "{"+"index"+"}", url.PathEscape(parameterToString(r.index, "")), -1)
