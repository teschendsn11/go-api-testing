...
// GetSubsections returns the Subsections field value if set, zero value otherwise.
func (o *RuleAllOf) GetSubsections() []APIReference {
	if o == nil || isNil(o.Subsections) {
		var ret []APIReference
		return ret
	}
	return o.Subsections
}

// GetSubsectionsOk returns a tuple with the Subsections field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RuleAllOf) GetSubsectionsOk() ([]APIReference, bool) {
	if o == nil || isNil(o.Subsections) {
    return nil, false
	}
	return o.Subsections, true
}
...
// SetSubsections gets a reference to the given []APIReference and assigns it to the Subsections field.
func (o *RuleAllOf) SetSubsections(v []APIReference) {
	o.Subsections = v
}

func (o RuleAllOf) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.Desc) {
		toSerialize["desc"] = o.Desc
	}
	if !isNil(o.Subsections) {
		toSerialize["subsections"] = o.Subsections
	}
	return json.Marshal(toSerialize)
}

type NullableRuleAllOf struct {
	value *RuleAllOf
	isSet bool
}

func (v NullableRuleAllOf) Get() *RuleAllOf {
	return v.value
}

func (v *NullableRuleAllOf) Set(val *RuleAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableRuleAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableRuleAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuleAllOf(val *RuleAllOf) *NullableRuleAllOf {
	return &NullableRuleAllOf{value: val, isSet: true}
}

func (v NullableRuleAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuleAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
