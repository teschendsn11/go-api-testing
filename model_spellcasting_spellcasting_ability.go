...
// SpellcastingSpellcastingAbility Reference to the `AbilityScore` used for spellcasting by the class.
type SpellcastingSpellcastingAbility struct {
...
func NewSpellcastingSpellcastingAbility() *SpellcastingSpellcastingAbility {
	this := SpellcastingSpellcastingAbility{}
	return &this
}
...
func (o SpellcastingSpellcastingAbility) MarshalJSON() ([]byte, error) {
...
type NullableSpellcastingSpellcastingAbility struct {
	value *SpellcastingSpellcastingAbility
	isSet bool
}

func (v NullableSpellcastingSpellcastingAbility) Get() *SpellcastingSpellcastingAbility {
	return v.value
}

func (v *NullableSpellcastingSpellcastingAbility) Set(val *SpellcastingSpellcastingAbility) {
	v.value = val
	v.isSet = true
}

func (v NullableSpellcastingSpellcastingAbility) IsSet() bool {
	return v.isSet
}

func (v *NullableSpellcastingSpellcastingAbility) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpellcastingSpellcastingAbility(val *SpellcastingSpellcastingAbility) *NullableSpellcastingSpellcastingAbility {
	return &NullableSpellcastingSpellcastingAbility{value: val, isSet: true}
}

func (v NullableSpellcastingSpellcastingAbility) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpellcastingSpellcastingAbility) UnmarshalJSON(src []byte) error {
	v.isSet = true
