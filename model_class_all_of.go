...
// ClassAllOf struct for ClassAllOf
type ClassAllOf struct {
...
func (o ClassAllOf) MarshalJSON() ([]byte, error) {
...
type NullableClassAllOf struct {
	value *ClassAllOf
	isSet bool
}

func (v NullableClassAllOf) Get() *ClassAllOf {
	return v.value
}

func (v *NullableClassAllOf) Set(val *ClassAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableClassAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableClassAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClassAllOf(val *ClassAllOf) *NullableClassAllOf {
	return &NullableClassAllOf{value: val, isSet: true}
}

func (v NullableClassAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClassAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
